...
namespace Aran.Aim.CAWProvider
{
    public class AranAixmReader
    {
        ...
        public void ReadFeatureTimeSlice (Feature feature)
        {
            string xmlText = Reader.ReadOuterXml ();

            XmlDocument xmlDoc = new XmlDocument ();
            xmlDoc.LoadXml (xmlText);
            XmlContext xmlContext = new XmlContext (xmlDoc.DocumentElement);
            (feature as IAixmSerializable).AixmDeserialize (xmlContext);
