...
namespace AIP.GUI
{
    public static class NativeMethods
    {
        ...
        /// </summary>
        /// <param name="hWnd">A handle to the window whose window procedure will receive the message. If this parameter is HWND_BROADCAST ((HWND)0xffff), the message is sent to all top-level windows in the system.</param>
        ...
        public struct CHANGEFILTERSTRUCT
        {
            ...
            /// <summary>
            /// If the function succeeds, this field contains one of the following values, <see cref="MessageFilterInfo"/>
            /// </summary>
