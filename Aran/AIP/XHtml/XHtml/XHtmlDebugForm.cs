...
namespace XHTML
{
    public partial class XHtmlDebugForm : Telerik.WinControls.UI.RadForm
    {
        bool suspendToggleEvents = false;
        public XHtmlDebugForm()
        {
            InitializeComponent();
        ...
        private void radRichTextEditor1_TextChanged(object sender, EventArgs e)
        {
            ...
            radTextBox2.Text = ConvertHTMLToAIPXML(ConvertRichTextToHTML(Editor.Document)).Replace(Environment.NewLine,
""); 
