...
namespace XHTML
{
    public partial class XHtmlForm : Telerik.WinControls.UI.RadForm
    {
        ...
        /// <summary>
        /// Return XHTML into Content field of RulesProcedures
        /// </summary>
        ...
        private void btn_OK_Click(object sender, EventArgs e)
        {
            try
            {
                string XHTML = ConvertHTMLToAIPXML(ConvertRichTextToHTML(Editor.Document));
            }
            catch (Exception ex)
            {
