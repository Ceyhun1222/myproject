...
{
    [Description("TouchDownLiftOffArea")]
    [CrudFeatureConfiguration(FeatureCategory = FeatureCategories.HelipadFeatureTypes)]
    public partial class AM_TouchDownLiftOffArea : AM_FeatureVerticalQuality
	{
        ...
        public override Enums.Feat_Type Feattype => Enums.Feat_Type.TouchDown_Lift_Off_Area;
