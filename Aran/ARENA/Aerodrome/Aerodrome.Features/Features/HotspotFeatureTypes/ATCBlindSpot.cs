...
namespace Aerodrome.Features
{
    ...
    public partial class AM_ATCBlindSpot : AM_FeatureBase
	{
        ...
        public AM_Nullable<string> idblind { get; set; }
        ...
        public override Enums.Feat_Type Feattype => Enums.Feat_Type.ATC_Blind_Spot;
