...
{
    [Description("RunwayShoulder")]
    [CrudFeatureConfiguration(FeatureCategory = FeatureCategories.RunwayFeatureTypes)]
    public partial class AM_RunwayShoulder : AM_FeatureVerticalQuality
	{  
        ...
        public override Enums.Feat_Type Feattype => Enums.Feat_Type.Runway_Shoulder;
