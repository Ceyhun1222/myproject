...
{
    [Description("BridgeSide")]
    [CrudFeatureConfiguration(FeatureCategory = FeatureCategories.TaxiwayFeatureTypes)]
    public partial class AM_BridgeSide : AM_FeatureVerticalQuality
	{
        ...
        public AM_Nullable<string> idlin { get; set; }

        [CrudPropertyConfiguration]
        public AM_Nullable<DropSide> dropside { get; set; }
        ...
        public override Enums.Feat_Type Feattype => Enums.Feat_Type.Bridge_Side;
