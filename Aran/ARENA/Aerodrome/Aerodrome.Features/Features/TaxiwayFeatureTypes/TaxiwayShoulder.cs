...
{
    [Description("TaxiwayShoulder")]
    [CrudFeatureConfiguration(FeatureCategory = FeatureCategories.TaxiwayFeatureTypes)]
    public partial class AM_TaxiwayShoulder : AM_FeatureVerticalQuality
	{
        ...
        public override Enums.Feat_Type Feattype => Enums.Feat_Type.Taxiway_Shoulder;
