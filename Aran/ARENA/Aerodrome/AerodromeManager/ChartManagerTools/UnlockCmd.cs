...
namespace ChartManagerTools
{
    ...
    /// </summary>
    [Guid("D3A8AB8A-A120-4738-AC6F-66FD9C22F8D0")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("AmdbManagerTools.UnlockCmd")]
    public sealed class UnlockCmd : BaseCommand
    {
        ...
        public UnlockCmd()
        {
            ...
            m_toolTip = "Unlock amdb";  //localizable text 
            m_name = "AmdbManager_Unlock";   //unique id, non-localizable (e.g. "MyCategory_ArcMapCommand")
