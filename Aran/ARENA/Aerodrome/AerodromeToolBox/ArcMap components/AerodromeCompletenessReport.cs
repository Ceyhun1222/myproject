...
namespace AerodromeToolBox
{
    ...
    [Guid("C472A623-DC6D-4FB7-98CA-833543434CCA")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("Aerodrome.AerodromeCompletenessReport")]
    public sealed class AerodromeCompletenessReport : BaseCommand
    {
        ...
        public AerodromeCompletenessReport()
        {
            //
            // TODO: Define values for the public properties
            //
            base.m_category = "Generate completeness report"; //localizable text
            base.m_caption = "Generate completeness report";  //localizable text
            base.m_message = "Generate completeness report";  //localizable text 
            base.m_toolTip = "Generate completeness report";  //localizable text 
            base.m_name = "AerodromeCompletenessReport";   //unique id, non-localizable (e.g. "MyCategory_ArcMapCommand")
            try
            {
                //
