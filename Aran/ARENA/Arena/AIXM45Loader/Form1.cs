...
namespace AIXM45Loader
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void Next_button_Click(object sender, EventArgs e)
        {
            ...
            {
                SaveAreaXmlfile();
                string PathToSpecificationFile = ArenaStatic.ArenaStaticProc.GetPathToSpecificationFile();
                Area = new AreaInfo();
        ...
        private void SaveAreaXmlfile()
        {
            ...
            string PathToSpecificationFile = ArenaStatic.ArenaStaticProc.GetPathToSpecificationFile();
            string PathToRegionsFile = ArenaStatic.ArenaStaticProc.GetPathToRegionsFile();
        ...
        private void DecodeAIXM45_File()
        {
            ...
            var _info = from _xdoc in xdoc.Descendants("AIXM-Snapshot")
                          where _xdoc.Attribute("version") != null
                          select new aixm45FileINFO
                          {
                              Version = _xdoc.Attribute("version").Value,
                              Effective = _xdoc.Attribute("effective").Value,
                              Created = _xdoc.Attribute("created").Value,
                              Origin = _xdoc.Attribute("origin").Value,
                          };

            ver = _info.FirstOrDefault();

            if ((ver == null) || (!ver.Version.StartsWith("4.5")))
            {
                MessageBox.Show("Incorrect file version!");
                return;
            }
                        ...
                        var aixm45_AhpList = from aixm45_obj in xdoc.Descendants("Ahp")
                                             ...
                                             select
                                                 new AIXM45_Airport
                                                 {
                                                     ...
                                                     //Info = new aixm45FileINFO { Created = ver.Created, Effective = ver.Effective, Origin = ver.Origin, Version = ver.Version},
                        ...
                        var aixm45_IlsList = from aixm45_obj in xdoc.Descendants("Ils")
                                             ...
                                             select
                                                 new AIXM45_ILS
                                                 {
                                                     ...
                                                     R_DmeMid = aixm45_obj.Element("DmeUid") != null ? aixm45_obj.Element("DmeUid").Attribute("mid").Value : Guid.NewGuid().ToString(),
            ...
            foreach (string SectionsType in ListOfSectionsType)
            {
                switch (SectionsType)
                {
                    ...
                    case("OB"):
                        ...
                        table = fWksp.OpenTable("Obstacle");
                        pCursor = table.Search(qfilter, false);
                    ...
                    case ("SID"):
                        ...
                        while (pRow != null)
                        {
                            AIXM45_ObjectsList.Add(new AIXM45_Procedure_SID
                            {
                                #region
                                ...
                                R_mid = pRow.get_Value(pRow.Fields.FindField("R_mid")) != null ? pRow.get_Value(pRow.Fields.FindField("R_mid")).ToString() : "",
                                codeRnp = pRow.get_Value(pRow.Fields.FindField("codeRnp")) != null ? pRow.get_Value(pRow.Fields.FindField("codeRnp")).ToString() : "",
                                txtDescr = pRow.get_Value(pRow.Fields.FindField("txtDescr")) != null ? pRow.get_Value(pRow.Fields.FindField("txtDescr")).ToString() : "",
                                txtDescrComFail = pRow.get_Value(pRow.Fields.FindField("txtDescrComFail")) != null ? pRow.get_Value(pRow.Fields.FindField("txtDescrComFail")).ToString() : "",
                                codeTypeRte = pRow.get_Value(pRow.Fields.FindField("codeTypeRte")) != null ? pRow.get_Value(pRow.Fields.FindField("codeTypeRte")).ToString() : "",   
                                txtRmk = pRow.get_Value(pRow.Fields.FindField("txtRmk")) != null ? pRow.get_Value(pRow.Fields.FindField("txtRmk")).ToString() : "",
                                R_AhpMid = pRow.get_Value(pRow.Fields.FindField("R_AhpMid")) != null ? pRow.get_Value(pRow.Fields.FindField("R_AhpMid")).ToString() : "",
                                R_RdnMid = pRow.get_Value(pRow.Fields.FindField("R_RdnMid")) != null ? pRow.get_Value(pRow.Fields.FindField("R_RdnMid")).ToString() : "",
                                R_codeCatAcft = pRow.get_Value(pRow.Fields.FindField("R_codeCatAcft")) != null ? pRow.get_Value(pRow.Fields.FindField("R_codeCatAcft")).ToString() : "",
                                R_codeTransId = pRow.get_Value(pRow.Fields.FindField("R_codeTransId")) != null ? pRow.get_Value(pRow.Fields.FindField("R_codeTransId")).ToString() : "",
                                R_txtDesig = pRow.get_Value(pRow.Fields.FindField("R_txtDesig")) != null ? pRow.get_Value(pRow.Fields.FindField("R_txtDesig")).ToString() : "",
                                R_CODETRANSTYPE = pRow.get_Value(pRow.Fields.FindField("R_CODETRANSTYPE")) != null ? pRow.get_Value(pRow.Fields.FindField("R_CODETRANSTYPE")).ToString() : "",
                    ...
                    case ("PL"):
                        ...
                        #region Transition & ProcedureLegs

                        qfilter.WhereClause = "id > 0";
                        table = fWksp.OpenTable("procedure_transition");
                        pCursor = table.Search(qfilter, false);
                        ...
                        while (pRow != null)
                        {
                            AIXM45_ObjectsList.Add(new ProcTransition()
                            {
                                #region

                                ID = Guid.NewGuid().ToString(),
                                Mid = pRow.get_Value(pRow.Fields.FindField("mid")) != null ? pRow.get_Value(pRow.Fields.FindField("mid")).ToString() : "",
                                TransId = pRow.get_Value(pRow.Fields.FindField("trans_id")) != null ? pRow.get_Value(pRow.Fields.FindField("trans_id")).ToString() : "",
                                TransType = pRow.get_Value(pRow.Fields.FindField("trans_type")) != null ? pRow.get_Value(pRow.Fields.FindField("trans_type")).ToString() : "",
                                Description = pRow.get_Value(pRow.Fields.FindField("description")) != null ? pRow.get_Value(pRow.Fields.FindField("description")).ToString() : "",
                                ProcedureMid = pRow.get_Value(pRow.Fields.FindField("fk_procedure_mid")) != null ? pRow.get_Value(pRow.Fields.FindField("fk_procedure_mid")).ToString() : "",
                                ProcedureType = pRow.get_Value(pRow.Fields.FindField("procedure_type")) != null ? pRow.get_Value(pRow.Fields.FindField("procedure_type")).ToString() : "",
                                PhaseType = pRow.get_Value(pRow.Fields.FindField("phase_type")) != null ? pRow.get_Value(pRow.Fields.FindField("phase_type")).ToString() : "",                                
                                #endregion
                            });
                        ...
                        table = fWksp.OpenTable("ProcedureLeg");
                        pCursor = table.Search(qfilter, false);
                        ...
                        while (pRow != null)
                        {
                            AIXM45_ObjectsList.Add(new AIXM45_Procedure_Leg()
                            {
                                #region

                                ID = Guid.NewGuid().ToString(),
                                R_RecomendedUse = pRow.get_Value(pRow.Fields.FindField("R_RecomendedUse")) != null ? pRow.get_Value(pRow.Fields.FindField("R_RecomendedUse")).ToString() : "",
                                R_RecomendedUse_type = pRow.get_Value(pRow.Fields.FindField("R_RecomendedUse_type")) != null ? pRow.get_Value(pRow.Fields.FindField("R_RecomendedUse_type")).ToString() : "",
                                R_RecomendedUse_mid = pRow.get_Value(pRow.Fields.FindField("R_RecomendedUse_mid")) != null ? pRow.get_Value(pRow.Fields.FindField("R_RecomendedUse_mid")).ToString() : "",
                                R_RecomendedUse_codeId = pRow.get_Value(pRow.Fields.FindField("R_RecomendedUse_codeId")) != null ? pRow.get_Value(pRow.Fields.FindField("R_RecomendedUse_codeId")).ToString() : "",
                                R_RecomendedUse_geoLat = pRow.get_Value(pRow.Fields.FindField("R_RecomendedUse_geoLat")) != null ? pRow.get_Value(pRow.Fields.FindField("R_RecomendedUse_geoLat")).ToString() : "",
                                R_RecomendedUse_geoLong = pRow.get_Value(pRow.Fields.FindField("R_RecomendedUse_geoLong")) != null ? pRow.get_Value(pRow.Fields.FindField("R_RecomendedUse_geoLong")).ToString() : "",
                                R_SignificantPointGroupFix = pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupFix")) != null ? pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupFix")).ToString() : "",
                                R_SignificantPointGroupFix_type = pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupFix_type")) != null ? pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupFix_type")).ToString() : "",
                                R_SignificantPointGroupFix_mid = pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupFix_mid")) != null ? pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupFix_mid")).ToString() : "",
                                R_SignificantPointGroupFix_codeId = pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupFix_codeId")) != null ? pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupFix_codeId")).ToString() : "",
                                R_SignificantPointGroupFix_geoLat = pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupFix_geoLat")) != null ? pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupFix_geoLat")).ToString() : "",
                                R_SignificantPointGroupFix_geoLong = pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupFix_geoLong")) != null ? pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupFix_geoLong")).ToString() : "",
                                R_SignificantPointGroupCentre = pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupCentre")) != null ? pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupCentre")).ToString() : "",
                                R_SignificantPointGroupCentre_type = pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupCentre_type")) != null ? pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupCentre_type")).ToString() : "",
                                R_SignificantPointGroupCentre_mid = pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupCentre_mid")) != null ? pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupCentre_mid")).ToString() : "",
                                R_SignificantPointGroupCentre_codeId = pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupCentre_codeId")) != null ? pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupCentre_codeId")).ToString() : "",
                                R_SignificantPointGroupCentre_geoLat = pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupCentre_geoLat")) != null ? pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupCentre_geoLat")).ToString() : "",
                                R_SignificantPointGroupCentre_geoLong = pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupCentre_geoLong")) != null ? pRow.get_Value(pRow.Fields.FindField("R_SignificantPointGroupCentre_geoLong")).ToString() : "",
                                codePhase = pRow.get_Value(pRow.Fields.FindField("codePhase")) != null ? pRow.get_Value(pRow.Fields.FindField("codePhase")).ToString() : "",
                                codeType = pRow.get_Value(pRow.Fields.FindField("codeType")) != null ? pRow.get_Value(pRow.Fields.FindField("codeType")).ToString() : "",
                                valCourse = pRow.get_Value(pRow.Fields.FindField("valCourse")) != null ? ToDouble(pRow.get_Value(pRow.Fields.FindField("valCourse")).ToString()) : 0,
                                codeTypeCourse = pRow.get_Value(pRow.Fields.FindField("codeTypeCourse")) != null ? pRow.get_Value(pRow.Fields.FindField("codeTypeCourse")).ToString() : "",
                                codeDirTurn = pRow.get_Value(pRow.Fields.FindField("codeDirTurn")) != null ? pRow.get_Value(pRow.Fields.FindField("codeDirTurn")).ToString() : "",
                                codeTurnValid = pRow.get_Value(pRow.Fields.FindField("codeTurnValid")) != null ? pRow.get_Value(pRow.Fields.FindField("codeTurnValid")).ToString() : "",
                                codeDescrDistVer = pRow.get_Value(pRow.Fields.FindField("codeDescrDistVer")) != null ? pRow.get_Value(pRow.Fields.FindField("codeDescrDistVer")).ToString() : "",
                                codeDistVerUpper = pRow.get_Value(pRow.Fields.FindField("codeDistVerUpper")) != null ? pRow.get_Value(pRow.Fields.FindField("codeDistVerUpper")).ToString() : "",
                                valDistVerUpper = pRow.get_Value(pRow.Fields.FindField("valDistVerUpper")) != null ? ToDouble(pRow.get_Value(pRow.Fields.FindField("valDistVerUpper")).ToString()) : 0,
                                uomDistVerUpper = pRow.get_Value(pRow.Fields.FindField("uomDistVerUpper")) != null ? pRow.get_Value(pRow.Fields.FindField("uomDistVerUpper")).ToString() : "",
                                codeDistVerLower = pRow.get_Value(pRow.Fields.FindField("codeDistVerLower")) != null ? pRow.get_Value(pRow.Fields.FindField("codeDistVerLower")).ToString() : "",
                                valDistVerLower = pRow.get_Value(pRow.Fields.FindField("valDistVerLower")) != null ? ToDouble(pRow.get_Value(pRow.Fields.FindField("valDistVerLower")).ToString()) : 0,
                                uomDistVerLower = pRow.get_Value(pRow.Fields.FindField("uomDistVerLower")) != null ? pRow.get_Value(pRow.Fields.FindField("uomDistVerLower")).ToString() : "",
                                valVerAngle = pRow.get_Value(pRow.Fields.FindField("valVerAngle")) != null ? ToDouble(pRow.get_Value(pRow.Fields.FindField("valVerAngle")).ToString()) : 0,
                                valSpeedLimit = pRow.get_Value(pRow.Fields.FindField("valSpeedLimit")) != null ? ToDouble(pRow.get_Value(pRow.Fields.FindField("valSpeedLimit")).ToString()) : 0,
                                uomSpeed = pRow.get_Value(pRow.Fields.FindField("uomSpeed")) != null ? pRow.get_Value(pRow.Fields.FindField("uomSpeed")).ToString() : "",
                                codeSpeedRef = pRow.get_Value(pRow.Fields.FindField("codeSpeedRef")) != null ? pRow.get_Value(pRow.Fields.FindField("codeSpeedRef")).ToString() : "",
                                valDist = pRow.get_Value(pRow.Fields.FindField("valDist")) != null ? ToDouble(pRow.get_Value(pRow.Fields.FindField("valDist")).ToString()) : 0,
                                valDur = pRow.get_Value(pRow.Fields.FindField("valDur")) != null ? ToDouble(pRow.get_Value(pRow.Fields.FindField("valDur")).ToString()) : 0,
                                uomDur = pRow.get_Value(pRow.Fields.FindField("uomDur")) != null ? pRow.get_Value(pRow.Fields.FindField("uomDur")).ToString() : "",
                                valTheta = pRow.get_Value(pRow.Fields.FindField("valTheta")) != null ? ToDouble(pRow.get_Value(pRow.Fields.FindField("valTheta")).ToString()) : 0,
                                valRho = pRow.get_Value(pRow.Fields.FindField("valRho")) != null ? ToDouble(pRow.get_Value(pRow.Fields.FindField("valRho")).ToString()) : 0,
                                valBankAngle = pRow.get_Value(pRow.Fields.FindField("valBankAngle")) != null ? ToDouble(pRow.get_Value(pRow.Fields.FindField("valBankAngle")).ToString()) : 0,
                                uomDistHorz = pRow.get_Value(pRow.Fields.FindField("uomDistHorz")) != null ? pRow.get_Value(pRow.Fields.FindField("uomDistHorz")).ToString() : "",
                                codeRepAtc = pRow.get_Value(pRow.Fields.FindField("codeRepAtc")) != null ? pRow.get_Value(pRow.Fields.FindField("codeRepAtc")).ToString() : "",
                                codeRoleFix = pRow.get_Value(pRow.Fields.FindField("codeRoleFix")) != null ? pRow.get_Value(pRow.Fields.FindField("codeRoleFix")).ToString() : "",
                                txtRmk = pRow.get_Value(pRow.Fields.FindField("txtRmk")) != null ? pRow.get_Value(pRow.Fields.FindField("txtRmk")).ToString() : "",
                                R_MasterProcMid = pRow.get_Value(pRow.Fields.FindField("R_MasterProcMid")) != null ? pRow.get_Value(pRow.Fields.FindField("R_MasterProcMid")).ToString() : "",
                                R_MasterProcType = pRow.get_Value(pRow.Fields.FindField("R_MasterProcType")) != null ? pRow.get_Value(pRow.Fields.FindField("R_MasterProcType")).ToString() : "",
                                R_NOSEQ = pRow.get_Value(pRow.Fields.FindField("R_NOSEQ")) != null ? Convert.ToInt32(pRow.get_Value(pRow.Fields.FindField("R_NOSEQ")).ToString()) : 0,
                                fk_transition_mid = pRow.get_Value(pRow.Fields.FindField("fk_transition_mid")) != null ? pRow.get_Value(pRow.Fields.FindField("fk_transition_mid")).ToString() : "",
                                Geometry = pRow.get_Value(pRow.Fields.FindField("SHAPE")) as IGeometry
                                #endregion
                            });
        ...
        private void dataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.SelectedRows[0].Cells["ID"].Value.ToString().CompareTo("") == 0)
            {
