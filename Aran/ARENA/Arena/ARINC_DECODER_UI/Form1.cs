    ...
    public partial class Form1 : Form
    {
            ...
            switch (p)
            {
                ...
                case (2):
                    if (!treeView3.Nodes[3].Checked)
                    {
                        ...
                        Area = AreaManager.AreaUtils.GetArea(ArenaStaticProc.GetPathToAreaFile());
                        double CM = (Area.AreaPolygon as IArea).Centroid.X;


                        if (comboBox1.Text.CompareTo("MASTER") == 0)
                            CreateAIRTRACKObjects();
                        else
                        ...
                        foreach (ILS_AIRTRACK ILS in ILS_LIST)
                        {
                            ...
                            if (rdn != null)
                            {
                                ...
                                if (((rdn.ARINC_OBJ as ARINC_Runway_Primary_Records).Runway_Identifier != null) && ((rdn.ARINC_OBJ as ARINC_Runway_Primary_Records).Airport_ICAO_Identifier.Trim() != null))
                                {
        ...
        private void CreateAIRTRACKObjects (AreaInfo Area)// (IGeometry _AreaPolygon)
        {
            ...
            foreach (ARINC_OBJECT _OBJ in ListOfObjects)
            {
                ...
                if ((AIRTRAC_Obj != null) && (AIRTRAC_Obj.Shape != null) && (AIRTRAC_Obj is AIRPORT_AIRTRACK))
                    ListOf_Object_AIRTRACK.Add(AIRTRAC_Obj);
                else if ((AIRTRAC_Obj != null) && (AIRTRAC_Obj.Shape !=null) && (AranUtilS.WithinPolygon(_AreaPolygon, AIRTRAC_Obj.Shape.Geometry as IPoint)))
                    ListOf_Object_AIRTRACK.Add(AIRTRAC_Obj);
        ...
        private void CreateAIRTRACKObjects()
        {
        ...
        private void SaveAreaXmlfile()
        {
            ...
            string PathToSpecificationFile = ArenaStaticProc.GetPathToSpecificationFile();
        ...
        private bool SaveARINCResults()
        {
            ...
            string objtp="";
            bool res = false;
            ArenaStaticProc.CloseProgressBar();
                ...
                if (parNd.Checked)
                {
                    ...
                    foreach (TreeNode chldNd in parNd.Nodes)
                    {
                        ...
                        if ((ListToSave!=null) && (ListToSave.Count>0))
                        {
                            ...
                            ArenaStaticProc.Serialize(Res, FilePath + FN);
                            res = true;
                            index++;
        ...
        private void DecodeARINCFile(string PathToArincFile)
        {
            ...
            ARINC_SPECIFICATION_FILE = ArenaStaticProc.GetPathToARINCSpecificationFile();
