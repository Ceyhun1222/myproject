...
namespace ARENA
{
    ...
    /// </summary>
    [Guid("75aba62e-6536-4e90-96d6-9f0a0b825773")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("Arena.ArenaDataFromAIXM51")]
    public sealed class ArenaDataFromAIXM51 : BaseCommand
    {
        ...
        public ArenaDataFromAIXM51()
        {
            //
            // TODO: Define values for the public properties
            //
            base.m_category = "Load data to Arena project file"; //localizable text
            base.m_caption = "load AIXM 5.1 data";  //localizable text
            base.m_message = "Load data from AIXM 5.1 file";  //localizable text 
            base.m_toolTip = "Load data from AIXM 5.1 file";  //localizable text 
            base.m_name = "ArenaDataFromAIXM51";   //unique id, non-localizable (e.g. "MyCategory_ArcMapCommand")
        ...
        public override void OnClick()
        {
            ...
            if (curEnvironment.pMap != null)
            {
                ...
                {
                    LogManager.GetLogger(GetType().Name).Info($" ----------Convert data from AIXM 5.1 XML to PDM is canceled ---------- ");
                    return;
                }
