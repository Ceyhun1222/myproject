...
namespace ARENA
{
    public partial class InputForm : Form
    {
        ...
        private void PropertyValueCmbBx_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            ArenaStaticProc.SetObjectValue(LinkedObject, ((ComboBox)sender).DataBindings[0].BindingMemberInfo.BindingField, obj);
        }
        ...
        private void propertyGrid1_PropertyValueChanged(object s, PropertyValueChangedEventArgs e)
        {
            ...
            if (e.ChangedItem.PropertyDescriptor.Name.CompareTo("Lat") == 0)
            {
                ...
                if (lat == 0) ArenaStaticProc.SetObjectValue(LinkedObject, e.ChangedItem.PropertyDescriptor.Name, e.OldValue);
            }
            ...
            if (e.ChangedItem.PropertyDescriptor.Name.CompareTo("Lon") == 0)
            {
                ...
                if (lon == 0) ArenaStaticProc.SetObjectValue(LinkedObject, e.ChangedItem.PropertyDescriptor.Name, e.OldValue);
            }
        }
