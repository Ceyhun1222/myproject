...
namespace PDM
{
    public class ApronMarking : Marking
    {
        [XmlElement]
        //[Browsable(false)]
        public CodeApronSectionType MarkingLocation { get; set; }

        [Description("Parent Apron")]
        [Browsable(false)]
        [PropertyOrder(10)]
        public string ID_Apron { get; set; }

        public override PDM_ENUM PDM_Type => PDM_ENUM.ApronMarking;
        ...
        public override void CompileRow(ref IRow row)
        {
            ...
            findx = row.Fields.FindField("ID_Apron"); if (findx >= 0) row.set_Value(findx, this.ID_Apron);
