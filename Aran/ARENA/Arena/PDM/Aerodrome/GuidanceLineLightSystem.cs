...
namespace PDM
{
    public class GuidanceLineLightSystem:LightSystem
    {
        [XmlElement]
        [Browsable(false)]
        public string GuidanceLine_ID { get; set; }

        public override PDM_ENUM PDM_Type => PDM_ENUM.GuidanceLineLightSystem;
        ...
        public override void CompileRow(ref IRow row)
        {
            ...
            findx = row.Fields.FindField("GuidanceLine_ID"); if (findx >= 0) row.set_Value(findx, this.GuidanceLine_ID);
