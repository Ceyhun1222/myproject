...
namespace PDM
{
    public class RunwayProtectAreaLightSystem: LightSystem
    {

        public string ID_RunwayProtectArea { get; set; }

        public CodeProtectAreaSectionType Position { get; set; }

        public override PDM_ENUM PDM_Type => PDM_ENUM.RunwayProtectAreaLightSystem;
        ...
        public override void CompileRow(ref IRow row)
        {
            ...
            findx = row.Fields.FindField("ProtectArea_ID"); if (findx >= 0) row.set_Value(findx, this.ID_RunwayProtectArea);
            ...
            findx = row.Fields.FindField("ProtectAreaSectionType"); if (findx >= 0) row.set_Value(findx, this.Position.ToString());
