...
namespace PDM
{
    public class TaxiwayLightSystem:LightSystem
    {
        [XmlElement]
        [Browsable(false)]
        public string Taxiway_ID { get; set; }

        public CodeTaxiwaySectionType Position { get; set; }

        public override PDM_ENUM PDM_Type => PDM_ENUM.TaxiwayLightSystem;
        ...
        public override void CompileRow(ref IRow row)
        {
            ...
            findx = row.Fields.FindField("Taxiway_ID"); if (findx >= 0) row.set_Value(findx, this.Taxiway_ID);
            ...
            findx = row.Fields.FindField("TaxiwaySectionType"); if (findx >= 0) row.set_Value(findx, this.Position.ToString());
