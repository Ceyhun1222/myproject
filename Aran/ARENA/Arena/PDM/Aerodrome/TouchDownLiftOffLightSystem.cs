...
namespace PDM
{
    public class TouchDownLiftOffLightSystem:LightSystem
    {
        public string ID_TouchDownLiftOff { get; set; }

        public CodeTLOFSectionType Position { get; set; }

        public override PDM_ENUM PDM_Type => PDM_ENUM.TouchDownLiftOffLightSystem;
        ...
        public override void CompileRow(ref IRow row)
        {
            ...
            findx = row.Fields.FindField("TouchDownSectionType"); if (findx >= 0) row.set_Value(findx, this.Position.ToString());
