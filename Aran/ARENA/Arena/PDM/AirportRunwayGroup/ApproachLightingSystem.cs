...
namespace PDM
{
    public class ApproachLightingSystem:LightSystem
    {
        [Browsable(false)]
        public string RunwayDirection_ID { get; set; }

        public override PDM_ENUM PDM_Type => PDM_ENUM.ApproachLightingSystem;
        ...
        public override void CompileRow(ref IRow row)
        {
            ...
            findx = row.Fields.FindField("RunwayDirection_ID"); if (findx >= 0) row.set_Value(findx, this.RunwayDirection_ID);
