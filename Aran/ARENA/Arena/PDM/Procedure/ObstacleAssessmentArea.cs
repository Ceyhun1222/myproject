...
namespace PDM
{
    ...
    public class ObstacleAssessmentArea : PDMObject
    {
        ...
        private double? _assessedAltitude = null;
        [PropertyOrder(40)]
        ...
        private double? _slopeLowerAltitude = null;
        [PropertyOrder(60)]
        ...
        private double? _gradientLowHigh = null;
        [PropertyOrder(80)]
        ...
        public override PDM_ENUM PDM_Type
        {
            get
            {
                return PDM_ENUM.ObstacleAssessmentArea;
            }
        } 
