...
namespace PDM
{
    ...
    public class SegmentPoint : PDMObject
    {
        ...
        private double? _leadRadial = null;
        ...
        {
            if (this.SegmentPointDesignator != null && this.PointRole != null)
                return this.PointRole.ToString() + " " + this.SegmentPointDesignator;
            else
                return  this.PointChoice.ToString();
        ...
        public override bool StoreToDB(Dictionary<Type, ITable> AIRTRACK_TableDic)
        {
            ...
            try
            {
                ...
                this.ExeptionDetails = new ExeptionMessage { Message = ex.Message, Source = ex.Source, StackTrace = ex.StackTrace }; res = false;
            } 
        ...
        public override string X_to_EW_DDMMSS()
        {
            ...
            try
            {
                ...
                double Xcoord = Math.Round(Coord, 10);

                int deg = (int)Xcoord;
                double delta = Math.Round((Xcoord - deg) * 60, 8);
        ...
        public override string Y_to_NS_DDMMSS()
        {
            ...
            try
            {
                ...
                double YCoord = Math.Round(Coord, 10);
                //X = RealMode(X, 360);

                int deg = (int)YCoord;
                double delta = Math.Round((YCoord - deg) * 60, 8);
