...
namespace ChartManagerTools
{
    ...
    /// </summary>
    [Guid("c631104a-b9a0-4c13-883b-817c9a1494d2")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("ChartManagerTools.InfoCmd")]
    public sealed class InfoCmd : BaseCommand
    {
        ...
        public InfoCmd()
        {
            ...
            m_toolTip = "Details of chart";  //localizable text
            m_name = "ChartManager_Info";   //unique id, non-localizable (e.g. "MyCategory_MyCommand")
