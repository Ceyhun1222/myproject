...
namespace ChartManagerTools
{
    ...
    /// </summary>
    [Guid("255e48dc-9b55-45d9-b0ee-99c1e9b92d00")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("ChartManagerTools.OpenManagerCmd")]
    public sealed class OpenManagerCmd : BaseCommand
    {
        ...
        public OpenManagerCmd()
        {
            ...
            m_toolTip = "Open Chart Manager";  //localizable text 
            m_name = "ChartManager_OpenManager";   //unique id, non-localizable (e.g. "MyCategory_ArcMapCommand")
