...
namespace ChartManagerTools
{
    ...
    /// </summary>
    [Guid("94c7a498-938e-45fe-b155-b15a6a515499")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("ChartManagerTools.PublishAndLockCmd")]
    public sealed class PublishAndLockCmd : BaseCommand
    {
        ...
        public PublishAndLockCmd()
        {
            ...
            m_toolTip = "Publish and Lock chart"; //localizable text 
            m_name = "ChartManager_Publish_Lock"; //unique id, non-localizable (e.g. "MyCategory_ArcMapCommand")
