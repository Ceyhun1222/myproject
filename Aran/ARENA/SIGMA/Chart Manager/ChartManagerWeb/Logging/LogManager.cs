...
namespace ChartManagerWeb.Logging
{
    public static class LogManager
    {
        ...
        {
            var appDir = Path.GetPathRoot(Environment.GetFolderPath(Environment.SpecialFolder.System));
        ...
        {
            appDir = Path.Combine(appDir, "Web logs");
