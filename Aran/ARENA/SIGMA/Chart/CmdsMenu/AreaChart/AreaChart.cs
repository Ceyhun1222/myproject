...
namespace SigmaChart
{
    ...
    /// </summary>
    [Guid("52766fb6-7a3b-49ce-9586-f90250f0dd1b")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("SigmaChart.AreaChart")]
    public sealed class AreaChart : BaseCommand
    {
        ...
        public AreaChart()
        {
            ...
            base.m_caption = "Area Chart";  //localizable text 
            base.m_message = "This should work in ArcMap/MapControl/PageLayoutControl";  //localizable text
            base.m_toolTip = "Area Chart";  //localizable text
            base.m_name = "NewAreaChart";   //unique id, non-localizable (e.g. "MyCategory_MyCommand")
        ...
        public override void OnClick()
        {
            if (((IMapDocument)m_application.Document).DocumentFilename.Length > 0)
            {
                ...
                if (!TerminalChartsUtil.CheckPdmProjectType(SigmaChartTypes.AreaChart, _DocumentFilename)) return;
            }
            ...
            AreaChartClass _Chart = new AreaChartClass { SigmaHookHelper = m_hookHelper, SigmaApplication = m_application };
            _Chart.CreateChart();
