...
namespace SigmaChart
{
    ...
    /// </summary>
    [Guid("20dc72b8-6167-417b-86c5-aa0018806c99")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("SigmaChart.AreaMinimumChart")]
    public sealed class AreaMinimumChart : BaseCommand
    {
        ...
        public AreaMinimumChart()
        {
            //
            // TODO: Define values for the public properties
            //
            base.m_category = "SigmaChart"; //localizable text
            base.m_caption = "Minimum altitude Chart";  //localizable text 
            base.m_message = "This should work in ArcMap/MapControl/PageLayoutControl";  //localizable text
            base.m_toolTip = "Minimum altitude Chart";  //localizable text
            base.m_name = "NewMinimumAltitudeChart ";   //unique id, non-localizable (e.g. "MyCategory_MyCommand")
        ...
        public override void OnClick()
        {
            if (((IMapDocument)m_application.Document).DocumentFilename.Length > 0)
            {
                ...
                if (!TerminalChartsUtil.CheckPdmProjectType(SigmaChartTypes.MinimumAltitudeChart, _DocumentFilename)) return;
            }
            ...
            MinimumAltitudeChart _Chart = new MinimumAltitudeChart { SigmaHookHelper = m_hookHelper, SigmaApplication = m_application };
            _Chart.CreateChart();
