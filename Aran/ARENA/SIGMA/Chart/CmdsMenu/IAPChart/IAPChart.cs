...
namespace SigmaChart.CmdsMenu.IAPChart
{
    /// <summary>
    /// Command that works in ArcMap/Map/PageLayout
    /// </summary>
    [Guid("08ff4ba5-33f0-4d9f-9f68-fbf65b584fce")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("SigmaChart.IAPChart")]
    public sealed class IAPChart : BaseCommand
    {
        ...
        public IAPChart()
        {
            ...
            base.m_caption = "IAP Chart";  //localizable text 
            base.m_message = "This should work in ArcMap/MapControl/PageLayoutControl";  //localizable text
            base.m_toolTip = "IAP Chart";  //localizable text
            base.m_name = "NewIAPChart";   //unique id, non-localizable (e.g. "MyCategory_MyCommand")
        ...
        public override void OnClick()
        {
            ...
            if (((IMapDocument)m_application.Document).DocumentFilename.Length > 0)
            {
                ...
                if (!TerminalChartsUtil.CheckPdmProjectType(SigmaChartTypes.IAPChart_Type, _DocumentFilename)) return;
            }
            ...
            IAPChartClass _Chart = new IAPChartClass { SigmaHookHelper = m_hookHelper, SigmaApplication = m_application };
            _Chart.CreateChart();
