...
namespace Aran.Aim.Data
{
    internal class Reader : IDataListener
    {
		...
		internal GettingResult GetAllStoredFeatIndices ( )
		{
			IDataReader dataReader = null;
			try
			{
		...
		//private GettingResult Changes ( Guid featIdentifier, FeatureType featType, int sequence, int correction)
		//{			
