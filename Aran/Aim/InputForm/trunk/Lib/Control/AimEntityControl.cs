...
{
    public partial class AimEntityControl : UserControl, IAObjectControl
    {
        ...
        public void LoadDbEntity (DBEntity dbEntity, AimClassInfo classInfo)
        {
            ...
            for (int i = 0; i < classInfo.Properties.Count; i++)
            {
                ...
                AimPropertyControl aimPropControl = new AimPropertyControl ();
                ui_tableLayoutPanel1.Controls.Add (aimPropControl);

                aimPropControl.SetProperty (aimProp, propInfo);
            }
        }
        ...
        private void ui_titlePanel_Paint (object sender, PaintEventArgs e)
        {
            ...
            string title = _uiClassInfo.Caption;
