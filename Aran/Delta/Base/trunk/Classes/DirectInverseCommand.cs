...
{
    /// <summary>
    /// Summary description for DirectDistanceCommand.
    /// </summary>
    [Guid("fb122247-7f64-451a-b490-a8d29237e0b8")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("Aran.Delta.EsriClasses.DirectInverseCommand")]
    public sealed class DirectInverseCommand : BaseCommand
    {
        ...
        public DirectInverseCommand()
        {
            //
            // TODO: Define values for the public properties
            //
            base.m_category = ""; //localizable text
            base.m_caption = "Direct and Inverse";  //localizable text
        ...
        public override void OnClick()
        {
            ...
            {
                System.Windows.MessageBox.Show(ex.Message, "Delta", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
