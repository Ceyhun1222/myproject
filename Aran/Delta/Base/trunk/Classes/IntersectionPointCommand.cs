...
namespace Aran.Delta.Classes
{
    ...
    /// </summary>
    [Guid("6db34ce7-eb79-40b0-a2f1-3fe0371f3d41")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("Aran.Delta.Classes.IntersectionPointCommand")]
    public sealed class IntersectionPointCommand : BaseCommand
    {
        ...
        public IntersectionPointCommand()
        {
            //
            // TODO: Define values for the public properties
            //
            base.m_category = ""; //localizable text
            base.m_caption = "Intersection Points";  //localizable text 
