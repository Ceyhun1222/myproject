...
using ObstacleManagementSystem.ViewModels.Account;
...
namespace ObstacleManagementSystem.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        {
            //var result = await _signInManager.PasswordSignInAsync("admin", "admin123", true, lockoutOnFailure: false);
            //if (result.Succeeded)
            //{
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    _logger.LogInformation("User creaIdentityRoleted a new account with password.");
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            return RedirectToAction(nameof(Login), GetConrollerName());
        }
        ...
        private IActionResult RedirectToLocal(string returnUrl)
        {
            ...
            {
                return RedirectToAction(nameof(HomeController.Index), GetConrollerName(nameof(HomeController)));
            }
        }
        ...
        public async Task<IActionResult> ValidateUsernameAsync(string username)
        {
            ...
            var res = "true";
            if (userName != null)
                res = string.Format("an account for username ({0}) already exists.", username);
            return Json(res);
        }
        ...
        public async Task<IActionResult> ValidateEmailAsync(string email)
        {
            ...
            var res = "true";
            if (userName != null)
                res = string.Format("an account for email ({0}) already exists.", email);
            return Json(res);
        }
    }
}