...
using ObstacleManagementSystem.ViewModels.Manage;
...
namespace ObstacleManagementSystem.Controllers
{
    ...
    public class ManageController : BaseController
    {
        ...
        public ManageController(
          ...
          ILogger<ManageController> logger, IStringLocalizer<ManageController> stringLocalizer,
        ...
        public async Task<IActionResult> ChangePassword()
        {
            ...
            var model = new ChangePasswordViewModel { StatusMessage = StatusMessage, HasEverChangedPassword = user.PasswordChanged };
            return View(model);
        }
