...
namespace ICAO015
{
    ...
    public class TriStateTreeView : System.Windows.Forms.TreeView
    {
        ...
        protected override void OnAfterCheck(System.Windows.Forms.TreeViewEventArgs e)
        {
            ...
            //foreach (TreeNode nodeone in frm.Trw.Nodes)
            //{
            //    TreeViewClass.HideCheckBox(frm.Trw, nodeone);
            //}
        ...
        protected void UpdateParentState(System.Windows.Forms.TreeNode tn)
        {
            ...
            if (tn.Level != 0 && tn.Level != 1)
            {
                if (tn.Level == 2)
                {
                    TreeNode secondparent = tn.Parent;
                    TreeNode firstparent = secondparent.Parent;

                    if (firstparent.Text == "VOR" || firstparent.Text == "DME" || firstparent.Text == "ILS")
                    {
                        MEtd(tn);
            ...
            if (tn.Level != 0)
            {
                if (tn.Level == 1)
                {
                    TreeNode firstparent = tn.Parent;

                    if (firstparent.Text == "NDB" || firstparent.Text == "Markers")
                    {
                        MEtd(tn);
        ...
        protected void MEtd(System.Windows.Forms.TreeNode tn)
        {
