    ...
    public static class InitOmega
    {
        ...
        public static bool InitCommand()
        {
            try
            {
                ...
                GlobalParams.Logger = GlobalParams.AranEnvironment.GetLogger("Omega");
...
//                var obstacleArea = GlobalParams.Database.OmegaQPI.GetObstacleArea();
                ...
                Omega.Properties.Resources.Culture = new System.Globalization.CultureInfo((int)Langcode);
                ...
                {
                    multiplier = 1;
                    unit = Omega.Properties.Resources.str111;
                }
                else
                {
                    multiplier = 1.0 / 1852.0;
                    unit = Omega.Properties.Resources.str520;
                }
                ...
                else if (_heightUnit == VerticalDistanceType.Ft)
                {
                    ...
                    unit = Omega.Properties.Resources.str112;
                }
            ...
            {
                MessageBox.Show(e.Message+Environment.NewLine+"Please see log for details!", "Omega", MessageBoxButtons.OK, MessageBoxIcon.Error);
