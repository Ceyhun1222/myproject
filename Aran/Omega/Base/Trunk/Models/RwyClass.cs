        ...
        public RwyClass(Runway rwy)
        {
            ...
            foreach (var rwyDir in rwyDirList)
            {
                ...
                catch (OmegaException e)
                {
                    ...
                    if (e.MessageType== ExceptionMessageType.ThresholdNotAvailable)
                        throw new Exception("No information about threshold input for RwyDirection " + rwyDir.Designator);
                }
