...
using Aran.Omega.TypeB.Properties;
...
//                var obstacleArea = GlobalParams.Database.OmegaQPI.GetObstacleArea();
                ...
                Omega.TypeB.Properties.Resources.Culture = new System.Globalization.CultureInfo((int)Langcode);
                ...
                {
                    multiplier = 1;
                    unit = Aran.Omega.TypeB.Properties.Resources.str111;
                }
                else
                {
