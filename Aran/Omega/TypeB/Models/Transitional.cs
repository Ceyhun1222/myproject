...
{
    public class Transitional:SurfaceBase
    {
        public Transitional()
        {
            ...
            SurfaceType = Aran.Panda.Constants.SurfaceType.Transitional;
        ...
        public override void CreateReport()
        {
            ...
            //var vsList = GlobalParams.Database.GetVerticalStructureList(extent);
                    ...
                    foreach (VerticalStructurePart vsPart in vs.Part)
                    {
                       ...
                       #region ElevatedSurface
                        ...
                        else
                        {
                            ...
                            {
                                //extentPrj = vs.GetGeom(partNumber); //GlobalParams.SpatialRefOperation.ToPrj(horizontalProj.SurfaceExtent.Geo);
                                obstacleElev = ConverterToSI.Convert(horizontalProj.SurfaceExtent.Elevation, 0);
                            }
                            else
                            {
                                //extentPrj = vs.GetGeom(partNumber);// GlobalParams.SpatialRefOperation.ToPrj(horizontalProj.LinearExtent.Geo); //;
                            ...
                            //var intersect = GlobalParams.GeomOperators.Intersect(extentEsriGeo, extentEsriPrj);
            ...
            {
                throw new Exception("Error Create reporting Transitional!");
