    ...
    public class DbModule
    {
        public DbModule()
        {
            try
            {
                ...
                DbProvider dbProvider = GlobalParams.Settings.DbConnection.DbProvider;
        ...
        public OrganisationAuthority GetOrganisation()
        {
            return OmegaQPI.GetFeature
                (FeatureType.OrganisationAuthority, GlobalParams.Settings.OLSQuery.Organization) as OrganisationAuthority;
        }
