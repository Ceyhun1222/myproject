...
namespace Aran.Omega.TypeB.Settings
{
    public class Symbols
    {
        static Symbols()
        {
            ...
            //Transitional symbols
            int innerTransitionalColor = ARANFunctions.RGB(10, 197, 45);
            InnerTransitionalDefaultSymbol = new FillSymbol();
            InnerTransitionalDefaultSymbol.Color = transitionalColor;
            InnerTransitionalDefaultSymbol.Outline = new LineSymbol(eLineStyle.slsInsideFrame, innerTransitionalColor, 1);
            InnerTransitionalDefaultSymbol.Size = 1;
            InnerTransitionalDefaultSymbol.Style = eFillStyle.sfsNull;

            InnerTransitionalSelectedSymbol = new FillSymbol();
            InnerTransitionalSelectedSymbol.Color = transitionalColor;
            InnerTransitionalSelectedSymbol.Outline = new LineSymbol(eLineStyle.slsNull, innerTransitionalColor, 2);
            InnerTransitionalSelectedSymbol.Size = 2;
            InnerTransitionalSelectedSymbol.Style = eFillStyle.sfsVertical;
            ...
            //BalkedLanding symbols
            int takeOffColor = ARANFunctions.RGB(119, 22, 45);
            TakeOfClimbDefaultSymbol = new FillSymbol();
            TakeOfClimbDefaultSymbol.Color = balkedColor;
            TakeOfClimbDefaultSymbol.Outline = new LineSymbol(eLineStyle.slsInsideFrame, takeOffColor, 1);
            TakeOfClimbDefaultSymbol.Style = eFillStyle.sfsNull;

            TakeOfClimbSelectedSymbol = new FillSymbol();
            TakeOfClimbSelectedSymbol.Color = balkedColor;
            TakeOfClimbSelectedSymbol.Outline = new LineSymbol(eLineStyle.slsNull, takeOffColor, 2);
            TakeOfClimbSelectedSymbol.Style = eFillStyle.sfsHorizontal;
        ...
        public static FillSymbol InnerTransitionalDefaultSymbol { get; set; }
        public static FillSymbol InnerTransitionalSelectedSymbol { get; set; }
        ...
        public static FillSymbol TakeOfClimbDefaultSymbol { get; set; }
        public static FillSymbol TakeOfClimbSelectedSymbol { get; set; }
