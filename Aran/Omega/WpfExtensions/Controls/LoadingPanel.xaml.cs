...
namespace WpfExtensions.Controls
{
    ...
    public partial class LoadingPanel
    {
        ...
        public static readonly DependencyProperty MessageProperty =
            DependencyProperty.Register("Message", typeof(string), typeof(LoadingPanel), new UIPropertyMetadata(string.Empty));
        ...
        {
            get => (ICommand)GetValue(ClosePanelCommandProperty);
