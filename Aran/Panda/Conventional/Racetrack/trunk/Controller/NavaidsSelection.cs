...
namespace Aran.Panda.Conventional.Racetrack
{
    public class SelectionAirdromeArea
    {
        ...
        {
			_navaids.SetRadius ( GlobalParams.UnitConverter.ToDistanceUnitFromUser ( radius ) );
        }
        ...
        private OrganisationAuthority SelectedOrg
        {
            ...
            set
            {
                ...
                {
                    AirportList = GlobalParams.Database.HoldingQpi.GetAdhpListDesignatorNotNull(_selectedOrg.Identifier);
                }
            }
        }
        ...
        private AirportHeliport SelectedAirport
        {
            ...
            set
            {
                ...
                {
                    _navaids.SetArp ( _selectedAirport.ARP.Geo.X, _selectedAirport.ARP.Geo.Y );
                }
            }
        }
        ...
        {
			OrgList = GlobalParams.Database.HoldingQpi.GetOrganisatioListDesignatorNotNull ( );
        }
    ...
    public class FixFacilities
    {
        ...
        public void SetNavaidList ( )
        {
			if ( ( _x != double.NaN ) && ( _y != double.NaN ) && _servicesInitialized )
				NavaidList = GlobalParams.Database.HoldingQpi.GetNavaidListByTypes ( new Aran.Geometries.Point ( _x, _y ), _radius, _navaidServTypes ); //GlobalParams.Database.HoldingQpi.GetNavaidListByTypes ( _x, _y, _radius, _navaidServTypes );
			else
				NavaidList = null;
        }
        ...
        private List<NavaidPntPrj> SetSelectedNavaid(Navaid navaid)
        {
            ...
            if ( _procTypeConv == ProcedureTypeConv.ProcType_VORDME )
            {
                ...
                {
                    if ( _selectedNavaid.NavaidEquipment [0].TheNavaidEquipment.Type == Aran.Aim.NavaidEquipmentType.VOR)
                    {
						Vor = ( VOR ) _selectedNavaid.NavaidEquipment [ 0 ].TheNavaidEquipment.GetFeature ( );
						Dme = ( DME ) _selectedNavaid.NavaidEquipment [ 1 ].TheNavaidEquipment.GetFeature ( );
                    }
                    else
                    {
						Vor = ( VOR ) _selectedNavaid.NavaidEquipment [ 1 ].TheNavaidEquipment.GetFeature ( );
						Dme = ( DME ) _selectedNavaid.NavaidEquipment [ 0 ].TheNavaidEquipment.GetFeature ( );
                    }
                }
            ...
            else if ( _procTypeConv == ProcedureTypeConv.ProcType_VOR_NDB )
            {
                ...
                {
                    if ( _selectedNavaid.NavaidEquipment.Count > 1 )
                    {
						if ( _selectedNavaid.NavaidEquipment [ 0 ].TheNavaidEquipment.Type == Aran.Aim.NavaidEquipmentType.VOR )
                        {
							Vor = ( VOR ) _selectedNavaid.NavaidEquipment [ 0 ].TheNavaidEquipment.GetFeature ( );
						...
						else if ( _selectedNavaid.NavaidEquipment [ 1 ].TheNavaidEquipment.Type == Aran.Aim.NavaidEquipmentType.VOR )
                        {
							Vor = ( VOR ) _selectedNavaid.NavaidEquipment [ 1 ].TheNavaidEquipment.GetFeature ( );
                            result.Add ( new NavaidPntPrj ( VorPntPrj, NavType.NavType_Vor ) );
                        }
						else if ( _selectedNavaid.NavaidEquipment [ 0 ].TheNavaidEquipment.Type == Aran.Aim.NavaidEquipmentType.NDB )
                        {
							Ndb = ( NDB ) _selectedNavaid.NavaidEquipment [ 0 ].TheNavaidEquipment.GetFeature ( );
                            result.Add ( new NavaidPntPrj ( NdbPntPrj, NavType.NavType_NDB ) );
                        }
						else if ( _selectedNavaid.NavaidEquipment [ 1 ].TheNavaidEquipment.Type == Aran.Aim.NavaidEquipmentType.NDB )
                        {
							Ndb = ( NDB ) _selectedNavaid.NavaidEquipment [ 1 ].TheNavaidEquipment.GetFeature ( );
                            result.Add ( new NavaidPntPrj ( NdbPntPrj, NavType.NavType_NDB ) );
                        }
                    }
                    else
        ...
        public VOR Vor
        {
            ...
            private set
            {
                ...
                {
					VorPntGeo = GeomFunctions.AimToAranPoint ( _vor.Location.Geo ); //GeomFunctions.GmlToAranPoint ( _vor );
        ...
        public DME Dme
        {
            ...
            private set
            {
                ...
                else
                {
					...
					DmePntGeo = GeomFunctions.AimToAranPoint ( _dme.Location.Geo );//GeomFunctions.GmlToAranPoint ( _dme );
        ...
        public NDB Ndb
        {
            ...
            set
            {
                ...
                {
					NdbPntGeo = GeomFunctions.AimToAranPoint ( _ndb.Location.Geo ); //GeomFunctions.GmlToAranPoint ( _ndb );
