...
namespace Aran.PANDA.Departure
{
	...
	public sealed class DepartOmniDirectCMD : BaseCommand
	{
		...
		public DepartOmniDirectCMD()
		{
			...
			base.m_helpID = 2000;
			base.m_bitmap = null;
			base.m_caption = Resources.str15063;		//"В любом направлении"
			base.m_message = Resources.str15066;		//"Вылет во всех направлениях"
			base.m_toolTip = Resources.str15066;		//"Вылет во всех направлениях"
		}
		...
		public override string Caption
		{
			get
			{
				...
				Resources.Culture = new System.Globalization.CultureInfo(GlobalVars.LangCode);
#if (ADD_NET)
				return Resources.str15063 + "_NET";		//	"В любом направлении"
#else
				return Resources.str15063;				//	"В любом направлении"
#endif
			}
		}
		...
		public override string Message
		{
			get
			{
				...
				return Resources.str15066;	//"Вылет во всех направлениях"
			}
		}
