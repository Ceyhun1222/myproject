...
namespace Aran.PANDA.Departure
{
	...
	public sealed class DepartRoutsCMD : BaseCommand
	{
		...
		public DepartRoutsCMD()
		{
			...
			base.m_helpID = 4000;
			base.m_bitmap = null;
			base.m_caption = Resources.str15270;		//"Без наведения"
			base.m_message = Resources.str15271;		//"Вылет без наведения"
			base.m_toolTip = Resources.str15271;		//"Вылет без наведения"
		}
		...
		public override string Caption
		{
			get
			{
				...
				Resources.Culture = new System.Globalization.CultureInfo(GlobalVars.LangCode);
#if (ADD_NET)
				return Resources.str15270 + "_NET";		//	"Без наведения"
#else
				return Resources.str15270;				//	"Без наведения"
#endif
			}
		}
		...
		public override string Message
		{
			get
			{
				...
				return Resources.str15271;	//"Вылет без наведения"
			}
		}
