...
namespace ETOD
{
	...
	/// </summary>
	[Guid("EED32423-A683-408D-9333-38B8AA74D549")]
	[ClassInterface(ClassInterfaceType.None)]
	[ProgId("ETOD.VerifyCMD")]

	public sealed class VerifyCMD : BaseCommand
	{
		...
		public VerifyCMD()
		{
			...
			base.m_name = "VerifyCMD";			//	unique id, non-localizable

			base.m_helpFile = GlobalVars.HelpFile;
			base.m_helpID = 0;
			base.m_bitmap = null;
			base.m_caption = Resources.Str5;		//"ETOD"
			base.m_message = Resources.Str6;		//"ETOD"
			base.m_toolTip = Resources.Str6;		//"ETOD"
		}
		...
		public override void OnClick()
		{
			...
			try
			{
				...
				//CVarifyFrm VarifyFrm = new CVarifyFrm();
				//VarifyFrm.Show(GlobalVars.m_Win32Window);
				////VarifyFrm.ComboBox001.Focus();
