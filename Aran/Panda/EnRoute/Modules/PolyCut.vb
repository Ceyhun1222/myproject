...
<System.Runtime.InteropServices.ComVisibleAttribute(False)> Module PolyCut

	<System.Runtime.InteropServices.ComVisibleAttribute(False)> Private Structure TIntersections
	...
	<System.Runtime.InteropServices.ComVisibleAttribute(False)> Private Structure TPointsHeap
		Dim pPoint As ESRI.ArcGIS.Geometry.IPoint
	...
	Public Function ClipByLine(ByVal pClipPolygon As ESRI.ArcGIS.Geometry.Polygon, ByVal pCutLine As ESRI.ArcGIS.Geometry.Polyline, ByRef pLeft As ESRI.ArcGIS.Geometry.Polygon, ByRef pRight As ESRI.ArcGIS.Geometry.Polygon, ByRef pUnspecified As ESRI.ArcGIS.Geometry.Polygon) As Integer
	...
	Public Function ClipByPoly(ByRef pClipLine As ESRI.ArcGIS.Geometry.Polyline, ByRef pCutPolygon As ESRI.ArcGIS.Geometry.Polygon) As ESRI.ArcGIS.Geometry.Polyline
		...
		Dim pIntersectionPoints() As TIntersections = Nothing
		...
		If iRings = 0 Then Exit Function
