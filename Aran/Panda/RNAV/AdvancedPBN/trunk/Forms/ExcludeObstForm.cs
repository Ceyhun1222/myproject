...
{
	public partial class ExcludeObstForm : Form
	{
		...
		public bool ExcludeOstacles(ref ObstacleContainer Obstacles, Form mainForm)
		{
			...
			for (I = 0; I < M; I++)
			{
				...
				itmX.SubItems.Insert(2, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Obstacles[I].Height, eRoundMode.NEAREST).ToString()));
		...
		private void ListView1_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			else if (LObstaclesPage1.Obstacles[Item.Index].pGeomPrj.Type == GeometryType.MultiLineString)
			{
				...
				pGeomElem = GlobalVars.gAranGraphics.DrawMultiLineString(multiLine, 2, 255);
			}
			else //if LObstaclesPage11[Item.Index].pGeomPrj.GeometryType = ArcGIS.Geometry.esriGeometryType.esriGeometryPolygon)
			{
				...
				pGeomElem = GlobalVars.gAranGraphics.DrawMultiPolygon(multiPolygon, AranEnvironment.Symbols.eFillStyle.sfsDiagonalCross, 255);
			}

			pPointElem = GlobalVars.gAranGraphics.DrawPointWithText(pPtTmp, LObstaclesPage1.Obstacles[Item.Index].UnicalName, 255);
		}
