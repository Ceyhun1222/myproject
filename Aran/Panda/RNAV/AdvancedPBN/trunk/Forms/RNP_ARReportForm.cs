...
namespace Aran.PANDA.RNAV.SGBAS
{
	public partial class RNP_ARReportForm : Form
	{
		...
		public RNP_ARReportForm()
		{
			...
			ListView02.Columns[4].Text = "Equvalent height (" + GlobalVars.unitConverter.HeightUnit + ")";	//Equvalent H
			ListView02.Columns[5].Text = "H penet." + " (" + GlobalVars.unitConverter.HeightUnit + ")";	//Penetrate
			ListView02.Columns[6].Text = "Req OCH" + " (" + GlobalVars.unitConverter.HeightUnit + ")";	//Req. OCH
			ListView02.Columns[7].Text = "X (" + GlobalVars.unitConverter.HeightUnitM + ")";	//LoadResString() 'X
			ListView02.Columns[8].Text = "Y (" + GlobalVars.unitConverter.HeightUnitM + ")";	//LoadResString() 'Y
			...
			ListView03.Columns[4].Text = "H penet." + " (" + GlobalVars.unitConverter.HeightUnit + ")"; //Penetrate
			ListView03.Columns[5].Text = "X (" + GlobalVars.unitConverter.HeightUnitM + ")";    //LoadResString() 'X
			...
			//ListView04.Columns[6].Text = "X from FAP (" + GlobalVars.unitConverter.HeightUnitM + ")";	//
			//ListView04.Columns[7].Text = "Y (" + GlobalVars.unitConverter.HeightUnitM + ")";	//LoadResString() 'Y
			...
			dataGridView07.Columns[2].HeaderText = "Height above THR" + " (" + GlobalVars.unitConverter.HeightUnit+")";
			dataGridView07.Columns[3].HeaderText = "Elevation" + " (" + GlobalVars.unitConverter.HeightUnit + ")";
			dataGridView07.Columns[4].HeaderText = "MOC" + " (" + GlobalVars.unitConverter.HeightUnit + ")";
			dataGridView07.Columns[5].HeaderText = "Req. H" + " (" + GlobalVars.unitConverter.HeightUnit+")";
			//dataGridView07.Columns[2].HeaderText = "d0"+" (" + GlobalVars.unitConverter.DistanceUnit + ")";
			//dataGridView07.Columns[3].HeaderText = "d0Sum" + " (" + GlobalVars.unitConverter.DistanceUnit+")";
			//dataGridView07.Columns[8].HeaderText = "H penet." + " (" + GlobalVars.unitConverter.HeightUnit + ")";
			//dataGridView07.Columns[9].HeaderText = "Area";

			dataGridView08.Columns[0].HeaderText = "Type";
			dataGridView08.Columns[1].HeaderText = "Name";
			dataGridView08.Columns[2].HeaderText = "Height above THR" + " (" + GlobalVars.unitConverter.HeightUnit + ")";
			dataGridView08.Columns[3].HeaderText = "Elevation" + " (" + GlobalVars.unitConverter.HeightUnit + ")";
			dataGridView08.Columns[4].HeaderText = "MOC" + " (" + GlobalVars.unitConverter.HeightUnit+")";
			dataGridView08.Columns[5].HeaderText = "Req. H" + " (" + GlobalVars.unitConverter.HeightUnit + ")";
			//dataGridView08.Columns[2].HeaderText = "d0" + " (" + GlobalVars.unitConverter.DistanceUnit + ")";
			//dataGridView08.Columns[3].HeaderText = "d0Sum" + " (" + GlobalVars.unitConverter.DistanceUnit + ")";
			//dataGridView08.Columns[8].HeaderText = "H penet." + " (" + GlobalVars.unitConverter.HeightUnit + ")";
		...
		public void FillPage01(ObstacleContainer Obstacles)
		{
			...
			for (i = 0; i < n; i++)
			{
				...
				itmX.SubItems.Insert(7, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, GlobalVars.OFZPlaneNames[(int)Obstacles.Parts[i].Plane]));
		...
		private void ListView01_ColumnClick(object sender, ColumnClickEventArgs e)
		{
				...
				for (i = 0; i < n; i++)
					switch (ColumnHeader.Index)
					{
						...
						case 1:
							...
							break;
						case 7:
							_page01Obstacles.Parts[i].sSort = GlobalVars.OFZPlaneNames[(int)_page01Obstacles.Parts[i].Plane & 15];
							break;
					}
			...
			for (i = 0; i < n; i++)
			{
				...
				itmX.SubItems[7].Text = GlobalVars.OFZPlaneNames[(int)_page01Obstacles.Parts[i].Plane & 15];
		...
		public void FillPage02(ObstacleContainer Obstacles)
		{
			...
			for (i = 0; i < n; i++)
			{
				...
				if ((int)Obstacles.Parts[i].Plane  == 2)
					itmX.SubItems.Insert(4, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].EffectiveHeight, eRoundMode.NEAREST).ToString()));
				else
					itmX.SubItems.Insert(4, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, "-"));

				itmX.SubItems.Insert(5, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].hPenet, eRoundMode.NEAREST).ToString()));
				itmX.SubItems.Insert(6, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].ReqOCH, eRoundMode.NEAREST).ToString()));
				...
				itmX.SubItems.Insert(9, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, GlobalVars.RNPARPlaneNames[(int)Obstacles.Parts[i].Plane & 15]));
		...
		private void ListView02_ColumnClick(object sender, ColumnClickEventArgs e)
		{
				...
				for (i = 0; i < n; i++)
					switch (ColumnHeader.Index)
					{
						...
						case 1:
							...
							break;
						case 9:
							_page02Obstacles.Parts[i].sSort = GlobalVars.RNPARPlaneNames[(int)_page02Obstacles.Parts[i].Plane & 15];
							break;
					}
			...
			for (i = 0; i < n; i++)
			{
				...
				if ((int)_page02Obstacles.Parts[i].Plane == 2)
					itmX.SubItems.Insert(4, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, GlobalVars.unitConverter.HeightToDisplayUnits(_page02Obstacles.Parts[i].EffectiveHeight, eRoundMode.NEAREST).ToString()));
				else
					itmX.SubItems.Insert(4, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, "-"));

				itmX.SubItems[5].Text = GlobalVars.unitConverter.HeightToDisplayUnits(_page02Obstacles.Parts[i].hPenet, eRoundMode.NEAREST).ToString();
				itmX.SubItems[6].Text = GlobalVars.unitConverter.HeightToDisplayUnits(_page02Obstacles.Parts[i].ReqOCH, eRoundMode.NEAREST).ToString();
				...
				itmX.SubItems[9].Text = GlobalVars.RNPARPlaneNames[(int)_page02Obstacles.Parts[i].Plane & 15];
		...
		private void ListView03_ColumnClick(object sender, ColumnClickEventArgs e)
		{
			...
			for (i = 0; i < n; i++)
			{
				...
				if (itmX.SubItems.Count > 4)
					itmX.SubItems[4].Text = GlobalVars.unitConverter.HeightToDisplayUnits(_page03Obstacles.Parts[i].hPenet, eRoundMode.NEAREST).ToString();
				else
					itmX.SubItems.Insert(4, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, GlobalVars.unitConverter.HeightToDisplayUnits(_page03Obstacles.Parts[i].hPenet, eRoundMode.NEAREST).ToString()));
		...
		//		itmX.SubItems.Insert(1, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, Obstacles.Obstacles[Obstacles.Parts[i].Owner].UnicalName));
		//		itmX.SubItems.Insert(2, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].Height, eRoundMode.NERAEST).ToString()));
		//		itmX.SubItems.Insert(3, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].MOC, eRoundMode.NERAEST).ToString()));
		//		itmX.SubItems.Insert(4, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].ReqH, eRoundMode.NERAEST).ToString()));
		...
		//		itmX.SubItems[2].Text = GlobalVars.unitConverter.HeightToDisplayUnits(_page04Obstacles.Parts[i].Height, eRoundMode.NERAEST).ToString();
		//		itmX.SubItems[3].Text = GlobalVars.unitConverter.HeightToDisplayUnits(_page04Obstacles.Parts[i].MOC, eRoundMode.NERAEST).ToString();
		//		itmX.SubItems[4].Text = GlobalVars.unitConverter.HeightToDisplayUnits(_page04Obstacles.Parts[i].ReqH, eRoundMode.NERAEST).ToString();
		...
		//		if (itmX.SubItems.Count > 2)
		//			itmX.SubItems[2].Text = GlobalVars.unitConverter.HeightToDisplayUnits(_page05Obstacles.Parts[i].hSurface, eRoundMode.NERAEST).ToString();
		//		else
		//			itmX.SubItems.Insert(2, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, GlobalVars.unitConverter.HeightToDisplayUnits(_page05Obstacles.Parts[i].hSurface, eRoundMode.NERAEST).ToString()));

		//		if (itmX.SubItems.Count > 3)
		//			itmX.SubItems[3].Text = GlobalVars.unitConverter.HeightToDisplayUnits(_page05Obstacles.Parts[i].Height, eRoundMode.NERAEST).ToString();
		//		else
		//			itmX.SubItems.Insert(3, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, GlobalVars.unitConverter.HeightToDisplayUnits(_page05Obstacles.Parts[i].Height, eRoundMode.NERAEST).ToString()));

		//		if (itmX.SubItems.Count > 4)
		//			itmX.SubItems[4].Text = GlobalVars.unitConverter.HeightToDisplayUnits(_page05Obstacles.Parts[i].ReqOCH, eRoundMode.NERAEST).ToString();
		//		else
		//			itmX.SubItems.Insert(4, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, GlobalVars.unitConverter.HeightToDisplayUnits(_page05Obstacles.Parts[i].ReqOCH, eRoundMode.NERAEST).ToString()));
		...
		//		itmX.SubItems.Insert(4, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].ReqH, eRoundMode.NERAEST).ToString()));
		//		itmX.SubItems.Insert(5, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].ReqOCH, eRoundMode.NERAEST).ToString()));
		//		itmX.SubItems.Insert(6, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].hPenet, eRoundMode.NERAEST).ToString()));
		//		itmX.SubItems.Insert(7, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, Obstacles.Parts[i].Dist.ToString("0.0")));

		//		if (Obstacles.Parts[i].TurnDistL > 0.0)
		//		{
		//			itmX.SubItems.Insert(8, new System.Windows.Forms.ListViewItem.ListViewSubItem(null, GlobalVars.unitConverter.DistanceToDisplayUnits(Obstacles.Parts[i].TurnDistL, eRoundMode.NERAEST).ToString()));
		...
		//		itmX.SubItems[2].Text = GlobalVars.unitConverter.HeightToDisplayUnits(_page06Obstacles.Parts[i].Height, eRoundMode.NERAEST).ToString();
		//		itmX.SubItems[3].Text = "-";
		//		itmX.SubItems[4].Text = GlobalVars.unitConverter.HeightToDisplayUnits(_page06Obstacles.Parts[i].ReqH, eRoundMode.NERAEST).ToString();
		//		itmX.SubItems[5].Text = GlobalVars.unitConverter.HeightToDisplayUnits(_page06Obstacles.Parts[i].ReqOCH, eRoundMode.NERAEST).ToString();
		//		itmX.SubItems[6].Text = GlobalVars.unitConverter.HeightToDisplayUnits(_page06Obstacles.Parts[i].hPenet, eRoundMode.NERAEST).ToString();
		//		itmX.SubItems[7].Text = _page06Obstacles.Parts[i].Dist.ToString("0.0");

		//		if (_page06Obstacles.Parts[i].TurnDistL > 0.0)
		//		{
		//			itmX.SubItems[8].Text = GlobalVars.unitConverter.DistanceToDisplayUnits(_page06Obstacles.Parts[i].TurnDistL, eRoundMode.NERAEST).ToString();
        ...
        public void FillPage07(ObstacleContainer Obstacles)//, ObstacleData DetObs
		{
			...
			for (i = 0; i < n; i++)
			{
				...
				row.Cells[2].Value = GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].Height, eRoundMode.NEAREST).ToString();

				row.Cells.Add(new DataGridViewTextBoxCell());
				row.Cells[3].Value = GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].Elev, eRoundMode.NEAREST).ToString();

				row.Cells.Add(new DataGridViewTextBoxCell());
				row.Cells[4].Value = GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].MOC, eRoundMode.NEAREST).ToString();

				row.Cells.Add(new DataGridViewTextBoxCell());
				row.Cells[5].Value = GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].ReqH, eRoundMode.NEAREST).ToString();
