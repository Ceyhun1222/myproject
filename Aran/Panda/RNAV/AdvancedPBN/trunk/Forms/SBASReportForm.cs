...
{
	public partial class SBASReportForm : Form
	{
		...
		public SBASReportForm()
		{
			...
			mainTabControl.TabPages[6].Text = "Current leg";
			mainTabControl.TabPages[7].Text = "Legs";
			...
			ListView02.Columns[8].Text = "SBAS category";
			...
			ListView03.Columns[4].Text = "Equivalent height (" + GlobalVars.unitConverter.HeightUnit + ")";		//Equivalent H
			...
			ListView03.Columns[9].Text = "SBAS Category";	//SBAS Category
			...
			dataGridView07.Columns[4].HeaderText = "Height above THR" + " (" + GlobalVars.unitConverter.HeightUnit+")";
			dataGridView07.Columns[5].HeaderText = "Elevation" + " (" + GlobalVars.unitConverter.HeightUnit + ")";
			dataGridView07.Columns[6].HeaderText = "MOC" + " (" + GlobalVars.unitConverter.HeightUnit + ")";
			dataGridView07.Columns[7].HeaderText = "Req. H" + " (" + GlobalVars.unitConverter.HeightUnit+")";
			...
			dataGridView08.Columns[4].HeaderText = "Height above THR" + " (" + GlobalVars.unitConverter.HeightUnit + ")";
			dataGridView08.Columns[5].HeaderText = "Elevation" + " (" + GlobalVars.unitConverter.HeightUnit + ")";
			dataGridView08.Columns[6].HeaderText = "MOC" + " (" + GlobalVars.unitConverter.HeightUnit+")";
			dataGridView08.Columns[7].HeaderText = "Req. H" + " (" + GlobalVars.unitConverter.HeightUnit + ")";
		...
		private void SBASReportForm_KeyUp(object sender, KeyEventArgs e)
		{
		...
		private void SBASReportForm_FormClosing(object sender, FormClosingEventArgs e)
		{
		...
		private void SBASReportForm_FormClosed(object sender, FormClosedEventArgs e)
		{
		...
		public void FillPage07(ObstacleContainer Obstacles, ObstacleData DetObs)
		{
			...
			for (i = 0; i < n; i++)
			{
				...
				row.Cells.Add(new DataGridViewTextBoxCell());
				row.Cells[8].Value = GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].hPenet, eRoundMode.NEAREST).ToString();
