...
namespace Aran.PANDA.RNAV.Approach
{
	...
	{
		public double ReferenceElevation { set; get; }
		...
		public void SaveObstacles1(string TabComment, System.Windows.Forms.DataGridView gridView, double MOC)
		{
			int n, m, i, j;
			...
			for (i = 0; i < m; i++)
			{
				Obstacle obst = (Obstacle)gridView.Rows[i].Tag;

				_excellExporter.CreateRow();
				_stwr.WriteLine("<tr>");

				double ReqOCH = obst.Height + MOC - ReferenceElevation;
				if (ReqOCH < MOC)
					ReqOCH = MOC;

				var obstacleGeoType = obst.pGeomPrj.Type;
				string strGeoType;
				if (obstacleGeoType == Geometries.GeometryType.Point)
					strGeoType = Resources.str10002;
				else if (obstacleGeoType == Geometries.GeometryType.LineString || obstacleGeoType == Geometries.GeometryType.MultiLineString)
					strGeoType = Resources.str10003;
				else
					strGeoType = Resources.str10004;


				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(obst.TypeName) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(obst.UnicalName) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(GlobalVars.unitConverter.HeightToDisplayUnits(obst.Height, eRoundMode.NEAREST).ToString()) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(GlobalVars.unitConverter.HeightToDisplayUnits(MOC, eRoundMode.NEAREST).ToString()) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(GlobalVars.unitConverter.HeightToDisplayUnits(ReqOCH, eRoundMode.NEAREST).ToString()) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(strGeoType) + "</td>");

				_stwr.WriteLine("</tr>");

				_excellExporter.Text(obst.TypeName);
				_excellExporter.Text(obst.UnicalName);
				_excellExporter.Text(GlobalVars.unitConverter.HeightToDisplayUnits(obst.Height, eRoundMode.NEAREST).ToString());
				_excellExporter.Text(GlobalVars.unitConverter.HeightToDisplayUnits(MOC, eRoundMode.NEAREST).ToString());
				_excellExporter.Text(GlobalVars.unitConverter.HeightToDisplayUnits(ReqOCH, eRoundMode.NEAREST).ToString());
				_excellExporter.Text(strGeoType);
			}
		...
		public void SaveObstacles2_4(string TabComment, System.Windows.Forms.DataGridView gridView, ObstacleContainer Obstacles)
		{
			int n, m, i, j;
			...
			for (i = 0; i < m; i++)
			{
				...
				if (Obstacles.Parts[i].Ignored)
					Ignored = Resources.str10046;
				else
					Ignored = Resources.str10047;
				...
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(strPrima) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(Ignored) + "</td>");
				_stwr.WriteLine("</tr>");
		...
		public void SaveObstacles5_8(string TabComment, System.Windows.Forms.DataGridView gridView, ObstacleContainer Obstacles, bool modified = false)
		{
			int i, j;
			...
			for (i = 0; i < m; i++)
			{
				...
				{
					if (Obstacles.Parts[i].Ignored)
						strIgnor = Resources.str10046;
					else
						strIgnor = Resources.str10047;
				}
				...
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].Elev, eRoundMode.NEAREST).ToString()) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].MOC, eRoundMode.NEAREST).ToString()) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].ReqH + ReferenceElevation, eRoundMode.NEAREST).ToString()) + "</td>");
				if (modified)
					_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(GlobalVars.unitConverter.GradientToDisplayUnits(Obstacles.Parts[i].PDG, eRoundMode.NEAREST).ToString()) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(GlobalVars.unitConverter.DistanceToDisplayUnits(Obstacles.Parts[i].Dist, eRoundMode.NEAREST).ToString()) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(GlobalVars.unitConverter.DistanceToDisplayUnits(Obstacles.Parts[i].CLShift, eRoundMode.NEAREST).ToString()) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(strPrima) + "</td>");
				if (!modified)
					_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(strIgnor) + "</td>");
				...
				_excellExporter.Text(GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].Elev, eRoundMode.NEAREST).ToString());
				_excellExporter.Text(GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].MOC, eRoundMode.NEAREST).ToString());
				_excellExporter.Text(GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].ReqH + ReferenceElevation, eRoundMode.NEAREST).ToString());
				if (modified)
					_excellExporter.Text(GlobalVars.unitConverter.GradientToDisplayUnits(Obstacles.Parts[i].PDG, eRoundMode.NEAREST).ToString());
				_excellExporter.Text(GlobalVars.unitConverter.DistanceToDisplayUnits(Obstacles.Parts[i].Dist, eRoundMode.NEAREST).ToString());
				_excellExporter.Text(GlobalVars.unitConverter.DistanceToDisplayUnits(Obstacles.Parts[i].CLShift, eRoundMode.NEAREST).ToString());
		...
		public void SaveObstacles9(string TabComment, System.Windows.Forms.DataGridView gridView, ObstacleContainer Obstacles)
		{
			int i, j;
			...
			for (i = 0; i < m; i++)
			{
				...
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(Obstacles.Obstacles[Obstacles.Parts[i].Owner].UnicalName) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].Elev, eRoundMode.NEAREST).ToString()) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(GlobalVars.unitConverter.HeightToDisplayUnits(fMOC30 * Obstacles.Parts[i].fSecCoeff, eRoundMode.NEAREST).ToString()) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].ReqOCH, eRoundMode.NEAREST).ToString()) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(GlobalVars.unitConverter.DistanceToDisplayUnits(Obstacles.Parts[i].Dist, eRoundMode.NEAREST).ToString()) + "</td>");
				//_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(GlobalVars.unitConverter.DistanceToDisplayUnits(Obstacles.Parts[i].CLShift, eRoundMode.NEAREST).ToString()) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(strPrima) + "</td>");
				...
				_excellExporter.Text(Obstacles.Obstacles[Obstacles.Parts[i].Owner].UnicalName);
				_excellExporter.Text(GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].Elev, eRoundMode.NEAREST).ToString());
				_excellExporter.Text(GlobalVars.unitConverter.HeightToDisplayUnits(fMOC30 * Obstacles.Parts[i].fSecCoeff, eRoundMode.NEAREST).ToString());
				_excellExporter.Text(GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].ReqOCH, eRoundMode.NEAREST).ToString());
				_excellExporter.Text(GlobalVars.unitConverter.DistanceToDisplayUnits(Obstacles.Parts[i].Dist, eRoundMode.NEAREST).ToString());
				//_excellExporter.Text(GlobalVars.unitConverter.DistanceToDisplayUnits(Obstacles.Parts[i].CLShift, eRoundMode.NEAREST).ToString());
				_excellExporter.Text(strPrima);
			}
		...
		public void SaveObstacles10(string TabComment, System.Windows.Forms.DataGridView gridView, ObstacleContainer Obstacles)
		{
			int i, j;
			...
			for (i = 0; i < m; i++)
			{
				...
				double ReqOCH = Obstacles.Parts[i].ReqOCH;
				if (ReqOCH < 0)
					ReqOCH = 0.0;

				double obMOC50 = fMOC50 * Obstacles.Parts[i].fSecCoeff;
				double fTA = Obstacles.Parts[i].Elev + obMOC50;

				double fTmp = ReqOCH - Obstacles.Parts[i].Height;
				if (fTmp < 0.0)
					fTmp = 0.0;
				...
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(Obstacles.Obstacles[Obstacles.Parts[i].Owner].UnicalName) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].Elev, eRoundMode.NEAREST).ToString()) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(GlobalVars.unitConverter.HeightToDisplayUnits(fTmp, eRoundMode.NEAREST).ToString()) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(GlobalVars.unitConverter.HeightToDisplayUnits(obMOC50, eRoundMode.NEAREST).ToString()) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(GlobalVars.unitConverter.HeightToDisplayUnits(ReqOCH, eRoundMode.NEAREST).ToString()) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(GlobalVars.unitConverter.HeightToDisplayUnits(fTA, eRoundMode.NEAREST).ToString()) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(GlobalVars.unitConverter.DistanceToDisplayUnits(Obstacles.Parts[i].Dist, eRoundMode.NEAREST).ToString()) + "</td>");
				//_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(GlobalVars.unitConverter.DistanceToDisplayUnits(Obstacles.Parts[i].CLShift, eRoundMode.NEAREST).ToString()) + "</td>");
				_stwr.WriteLine("<td>" + System.Net.WebUtility.HtmlEncode(strPrima) + "</td>");
				_stwr.WriteLine("</tr>");
				...
				_excellExporter.Text(Obstacles.Obstacles[Obstacles.Parts[i].Owner].UnicalName);
				_excellExporter.Text(GlobalVars.unitConverter.HeightToDisplayUnits(Obstacles.Parts[i].Elev, eRoundMode.NEAREST).ToString());
				_excellExporter.Text(GlobalVars.unitConverter.HeightToDisplayUnits(fTmp, eRoundMode.NEAREST).ToString());
				_excellExporter.Text(GlobalVars.unitConverter.HeightToDisplayUnits(obMOC50, eRoundMode.NEAREST).ToString());
				_excellExporter.Text(GlobalVars.unitConverter.HeightToDisplayUnits(ReqOCH, eRoundMode.NEAREST).ToString());
				_excellExporter.Text(GlobalVars.unitConverter.HeightToDisplayUnits(fTA, eRoundMode.NEAREST).ToString());
				_excellExporter.Text(GlobalVars.unitConverter.DistanceToDisplayUnits(Obstacles.Parts[i].Dist, eRoundMode.NEAREST).ToString());
				//_excellExporter.Text(GlobalVars.unitConverter.DistanceToDisplayUnits(Obstacles.Parts[i].CLShift, eRoundMode.NEAREST).ToString());
				_excellExporter.Text(strPrima);
			}
		...
		public void SaveObstacles11(string TabComment, System.Windows.Forms.DataGridView gridView, ObstacleContainer Obstacles)
		{
			int i, j;
		...
		public void SaveObstacles13(string TabComment, System.Windows.Forms.DataGridView gridView, ObstacleContainer Obstacles)
		{
			int i, j;
		...
		public void WritePoint(ReportPoint RepPoint, double refHeight)
		{
			...
			Param(Resources.str00569, GlobalVars.unitConverter.HeightToDisplayUnits(RepPoint.Height - refHeight, eRoundMode.NEAREST).ToString(), GlobalVars.unitConverter.HeightUnit);
		...
		public static ReportFile SaveGeometry(string RepFileName, string RepFileTitle, ReportHeader pReport, double refHeight, ReportPoint[] reportPoints, double allRoutsLen)
		{
			...
			for (int i = 0; i < n; i++)
				RoutsGeomRep.WritePoint(reportPoints[i], refHeight);
