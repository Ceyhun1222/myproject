...
namespace Aran.PANDA.RNAV.EnRoute
{
	...
	public static class DecoderCode
	{
		...
		public static int LstStDtWriter(string LCode, string ModuleName)
		{
		...
		public static MultiPolygon DecodeLCode(string LCode, string ModuleName)
		{
			...
			**/
			...
			//GlobalVars.gAranGraphics.DrawMultiPolygon(pResult,-1, AranEnvironment.Symbols.eFillStyle.sfsDiagonalCross );
