...
{
	public class PBNAPVBaroVNavPlugin : AranPlugin
	{
		private const string _plaginName = "PANDA RNAV - APV/Baro-VNAV";
		private readonly Guid _guid = new Guid("8F909FBD-DB3B-4153-9079-BCD42C4522A8");

		public override Guid Id { get { return _guid; } }

		public override string Name { get { return _plaginName; } }
