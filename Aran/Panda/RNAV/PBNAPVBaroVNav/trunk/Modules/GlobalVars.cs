...
namespace Aran.PANDA.RNAV.PBNAPVBaroVNav
{
	...
	public static class GlobalVars
	{
		...
		//const double H0h = 0;				// 0 ft
		public const double H1h = 5000 * 0.3048;   //<=5000 ft
		public const double H2h = 10000 * 0.3048;  //<=10000 ft

		public const double H0 = 75;               //<=5000 ft
		public const double H5000 = 105;           //<=10000 ft
		public const double H10000 = 120;          //>10000 ft
		...
		//public static string[] OFZSurfaceNames = { "Zero", "Inner Approach", "Inner transitional1", "Inner transitional2", "Balking landing", "Inner transitional2", "Inner transitional1", "Common" };
		public static string[] SurfaceNames = { "IA OCS", "FAS", "Horizontal", "Missed approach", "Final missed approach" };
