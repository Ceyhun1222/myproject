Module NativeMethods
	...
	'Public Declare Function GetStringFromTable Lib "MathFunctions.dll" (ByVal hModule As Long, ByVal uID As Long, ByVal lpBuffer As String, ByVal nBufferMax As Long, ByVal wLanguage As Integer) As Long
	...
	'Public Declare Function LoadIcon Lib "user32.dll" (ByVal hInstance As Long, ByVal Index As Long) As Long
	'Public Declare Function LoadImage Lib "user32.dll" (ByVal hInstance As Long, ByVal Index As Long, ByVal uType As Integer, ByVal cx As Integer, ByVal cy As Integer, ByVal fuLoad As Integer) As Long
	'Public Declare Function ShowDialog Lib "Workspace.dll" (ByVal hWnd As Long, Path As String, ByVal nSize As Long, Optional Title As String, Optional Comment As String) As Boolean
End Module
