...
namespace Aran.Queries
{
	public static class ExtensionFeature
	{
        ...
        public static Feature GetFeature(this FeatureRef featureRef)
        {
            ...
            if (AimMetadata.IsAbstractFeatureRef(featureRef)) {
                ...
                if (featureRef.FeatureType != null)
                    return CommonQPI.GetFeature(featureRef.FeatureType.Value, featureRef.Identifier);
		...
		public static Feature GetFeature2(this FeatureRef featureRef)
		{
            int featureTypeIndex;
            if (AimMetadata.IsAbstractFeatureRef(featureRef))
            {
        ...
        public static Feature GetFeature2(this FeatureRef featureRef, FeatureType featType)
        {
            return CommonQPI.GetFeature(featType, featureRef.Identifier);
        }
		...
		public static FeatureRef GetFeatureRef( this Feature feature)
		{
			...
			featureRef.FeatureType = feature.FeatureType;
