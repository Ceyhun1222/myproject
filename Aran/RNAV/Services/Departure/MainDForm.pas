...
{$ENDIF}	
	...
	rwyUnicalNameList := GObjectDirectory.GetRWYList (FParams.AHP.ID);
...
begin
	...
	rwyDirectionList := GObjectDirectory.RWYDirectionList [rwy.ID, FParams.AHP];
	...
	begin
		...
		cbRwyDirection.AddItem (rwyDirectionList.Item[i].AixmID, rwyDirectionList.Item[i]);
	end;
