...
namespace ARENA
{
    ...
    public class AIRPORT_PDM_Converter : IAIRTRACK_PDM_Converter
    {
        ...
        public RunwayDirection GetRunwayDirection(Object_AIRTRACK objAirtrack)
        {
            ...
            if ((AirtrackTHR.RelatedMarker != null) && (AirtrackTHR.RelatedMarker.Count >0))
            {
                ...
                mkrList.Components = new List<PDMObject>();
    ...
    public class Navaid_PDM_Converter : IAIRTRACK_PDM_Converter
    {
        ...
        public NavaidSystem GetNavaidSystem(Object_AIRTRACK objAirtrack)
        {
            ...
            ns.Components = new List<PDMObject>();
            ...
            if (objAirtrack is ILS_AIRTRACK)
            {
                ...
                if ((ILSAIRTRACK.RelatedDME != null) && (ILSAIRTRACK.RelatedDME is DME_AIRTRACK))
                {
                    ...
                    dme.DmeIdentifier = (AirtrackDME.ARINC_OBJ as ARINC_Navaid_VHF_Primary_Record).DME_Ident;
                ...
                {
                    ns.CodeNavaidSystemType = NavaidSystemType.ILS_TACAN;
            ...
            if (objAirtrack is NDB_AIRTRACK)
            {
                ...
                ndb.MagVar = ArincNDB.Magnetic_Variation;
            ...
            if (objAirtrack is VOR_AIRTRACK)
            {
                ...
                vor.VorIdentifier = ArincVOR.Navaid_Identifier;
                //vor.Frequency = ArincVOR.Frequency_Protection;
                ...
                if (AirtrackVOR.DME != null)
                {
                    ...
                    dme.DmeIdentifier = ArincVOR.DME_Ident;
                ...
                {
                    ns.CodeNavaidSystemType = NavaidSystemType.VOR_TAC;
                    TACAN tacan = new TACAN();
            ...
            if ((objAirtrack is DME_AIRTRACK) && ((objAirtrack as DME_AIRTRACK).VHF_code == VHF_NAVAID_AIRTRACK.VHF_NAVAID_code.DME))
            {
                ...
                dme.DmeIdentifier = ArincDME.DME_Ident;
            ...
            if ((objAirtrack is TACAN_AIRTRACK) && ((objAirtrack as TACAN_AIRTRACK).VHF_code == VHF_NAVAID_AIRTRACK.VHF_NAVAID_code.TACAN))
            {
                ...
                tacan.TacanIdentifier = ArincTACAN.DME_Ident;
            ...
            if ((RouteAIRTRACK.Segments != null) && (RouteAIRTRACK.Segments.Count > 0))
            {
                ...
                foreach (SEGMENT_AIRTRACK Airtrack_seg in RouteAIRTRACK.Segments)
                {
                    ...
                    if (Segment != null)
                    {
                        ...
                        Enrt.RouteLength = Enrt.RouteLength + Enrt.ConvertValueToMeter(Segment.ValLen, Segment.UomValLen.ToString());

                        Enrt.Routes.Add(Segment);
                    }
                }

                Enrt.RouteLength = Enrt.RouteLength / 1000;
            }
        ...
        public RouteSegment GetRouteSegment(Object_AIRTRACK objAirtrack)
        {
            ...
            if (SegmentAIRTRACK.StartPnt != null)
            {
                ...
                if (stPnt != null)
                {
                    ...
                    rsg.StartPoint.PointChoiceID = stPnt.SegmentPointDesignator;
            ...
            if (SegmentAIRTRACK.EndPnt != null)
            {
                ...
                if (endPnt != null)
                {
                    ...
                    rsg.EndPoint.PointChoiceID = endPnt.SegmentPointDesignator;
            ...
            if (ARINC_ENROUTE.Level.StartsWith("H")) rsg.CodeLvl = CODE_ROUTE_SEGMENT_CODE_LVL.UPPER_AIRSPACE;
            if (ARINC_ENROUTE.Level.StartsWith("L")) rsg.CodeLvl = CODE_ROUTE_SEGMENT_CODE_LVL.LOWER_AIRSPACE;

            rsg.CodeType = ARINC_ENROUTE.Route_Type;

            rsg.UomDistVerLower = UOM_DIST_VERT.FT;
            string s = ARINC_ENROUTE.Minimum_Altitude1;
            if (ARINC_ENROUTE.Minimum_Altitude1.StartsWith("FL"))
            {
                rsg.UomDistVerLower = UOM_DIST_VERT.FL;
                s = s.Remove(0, 2);
            }
            Double.TryParse(s, out d);
            rsg.ValDistVerLower = d;

            rsg.UomDistVerLowerOvrde = UOM_DIST_VERT.FT;
            s = ARINC_ENROUTE.Minimum_Altitude2;
            if (ARINC_ENROUTE.Minimum_Altitude2.StartsWith("FL"))
            {
                rsg.UomDistVerLowerOvrde = UOM_DIST_VERT.FL;
                s = s.Remove(0, 2);
            }
            Double.TryParse(s, out d);
            rsg.ValDistVerLowerOvrde = d;

            rsg.UomDistVerUpper = UOM_DIST_VERT.FL;
            ...
            if (rsg.Geo != null)
            {
                if (rsg.ValLen <= 0)
                {
                    rsg.ValLen = ArnUtil.GetDistanceBetweenPoints_Elips((rsg.Geo as IPolyline).FromPoint, (rsg.Geo as IPolyline).ToPoint)/1000;
                    rsg.UomValLen = UOM_DIST_HORZ.KM;
                ...
                if (rsg.ValTrueTrack <= 0)
                {
                    rsg.ValTrueTrack = az.Azimuth;
                }

                if (rsg.ValReversTrueTrack <= 0)
                {
    ...
    public class Airspace_PDM_Converter : IAIRTRACK_PDM_Converter
    {
        ...
        public AirspaceVolume GetAirspaceVolume(Object_AIRTRACK objAirtrack)
        {
            ...
            vol.CodeType = (AirspaceType)Enum.Parse(typeof(AirspaceType), AirtrackAispace.CodeType, true);
            ...
            {
                vol.UomDistVerLower = UOM_DIST_VERT.FL;
            ...
            {
                vol.UomDistVerLower = UOM_DIST_VERT.M;
                vol.ValDistVerLower_M = d;
            }
            else
            {
                vol.UomDistVerLower = UOM_DIST_VERT.FT;
            ...
            {
                vol.UomDistVerUpper = UOM_DIST_VERT.FL;
            ...
            {
                vol.UomDistVerUpper = UOM_DIST_VERT.M;
                vol.ValDistVerUpper_M = d;
            }
            else
            {
                vol.UomDistVerUpper = UOM_DIST_VERT.FT;
