...
namespace ARENA.Project
{
    public class ArenaProject : AbstractProject
    {
        ...
        private ESRI.ArcGIS.Controls.AxToolbarControl ArenaDepartureToolbarControl;
        ...
        public ArenaProject(Environment.Environment environment) : base(environment)
        {
            ...
            try
            {
                ...
                #region DepartureToolBox


                this.ArenaDepartureToolbarControl = new ESRI.ArcGIS.Controls.AxToolbarControl();
                ((System.ComponentModel.ISupportInitialize)(this.ArenaDepartureToolbarControl)).BeginInit();
                Environment.PandaToolBox.Controls.Add(this.ArenaDepartureToolbarControl);
                // 
                // ArenaDepartureToolbarControl
                // 
                System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MainForm));
                this.ArenaDepartureToolbarControl.SetBuddyControl(Environment.MapControl);
                this.ArenaDepartureToolbarControl.Dock = System.Windows.Forms.DockStyle.Left;
                this.ArenaDepartureToolbarControl.Location = new System.Drawing.Point(425, 0);
                this.ArenaDepartureToolbarControl.Name = "ArenaDepartureToolbarControl";
                this.ArenaDepartureToolbarControl.OcxState = ((System.Windows.Forms.AxHost.State)(resources.GetObject("ArenaDepartureToolbarControl.OcxState")));
                this.ArenaDepartureToolbarControl.Size = new System.Drawing.Size(273, 28);
                this.ArenaDepartureToolbarControl.TabIndex = 6;

                this.ArenaDepartureToolbarControl.AddMenuItem("PANDA.DepartureMenu", 0, false, 0);

                this.ArenaDepartureToolbarControl.AddItem("Departure.CircleVTool", -1, -1, false, 0, ESRI.ArcGIS.SystemUI.esriCommandStyles.esriCommandStyleIconOnly);
                this.ArenaDepartureToolbarControl.AddItem("Departure.CLVTool", -1, -1, false, 0, ESRI.ArcGIS.SystemUI.esriCommandStyles.esriCommandStyleIconOnly);
                this.ArenaDepartureToolbarControl.AddItem("Departure.StraightVTool", -1, -1, false, 0, ESRI.ArcGIS.SystemUI.esriCommandStyles.esriCommandStyleIconOnly);
                this.ArenaDepartureToolbarControl.AddItem("Departure.TurnAreaVTool", -1, -1, false, 0, ESRI.ArcGIS.SystemUI.esriCommandStyles.esriCommandStyleIconOnly);
                this.ArenaDepartureToolbarControl.AddItem("Departure.SecondaryVTool", -1, -1, false, 0, ESRI.ArcGIS.SystemUI.esriCommandStyles.esriCommandStyleIconOnly);
                this.ArenaDepartureToolbarControl.AddItem("Departure.NomTrackVTool", -1, -1, false, 0, ESRI.ArcGIS.SystemUI.esriCommandStyles.esriCommandStyleIconOnly);
                this.ArenaDepartureToolbarControl.AddItem("Departure.KKVTool", -1, -1, false, 0, ESRI.ArcGIS.SystemUI.esriCommandStyles.esriCommandStyleIconOnly);
                this.ArenaDepartureToolbarControl.AddItem("Departure.FIXVTool", -1, -1, false, 0, ESRI.ArcGIS.SystemUI.esriCommandStyles.esriCommandStyleIconOnly);

                this.ArenaDepartureToolbarControl.BringToFront();

                ((System.ComponentModel.ISupportInitialize)(this.ArenaDepartureToolbarControl)).EndInit();
        ...
        public override void FillObjectsTree()
        {
            ...
            foreach (NavaidSystem ns in navList)
            {
                if (ns.Components != null)
                {
                    ...
                    if (ns.CodeNavaidSystemType == NavaidSystemType.VOR_TAC) vorTacanNode.Nodes.Add(nsNode);
        ...
        public override void TreeViewAfterCheck(object sender, TreeViewEventArgs e)
        {
            try
            {
                ...
                IMap pMap = Environment.MapControl.Map;
                pMap.ClearSelection();
        ...
        private void StopSnappingProcess()
        {
            ...
            {
                snp.StopSnapping();
                Environment.MapControl.ActiveView.FocusMap.ClearSelection();
                ((IActiveView)Environment.MapControl.ActiveView.FocusMap).Refresh();
                snp = null;
            }
            catch { }
        }
        ...
        public void StartSnappingProcess()
        {
            ...
            try
            {
                ...
                List<string> layersnames = EsriUtils.getMapLayerNames(Environment.MapControl.ActiveView.FocusMap);

                for (int i = layersnames.Count - 1; i >= 0; i--)
                {
                    string Nm = layersnames[i];
                    ILayer lyr = EsriUtils.getLayerByName(Environment.MapControl.ActiveView.FocusMap, Nm);
                ...
                ISpatialReference spatRefGeo = Environment.MapControl.ActiveView.FocusMap.SpatialReference;

                ESRI.ArcGIS.Display.IDisplayTransformation dspTrans = (Environment.MapControl.ActiveView.FocusMap as ESRI.ArcGIS.Carto.IActiveView).ScreenDisplay.DisplayTransformation;

                ESRI.ArcGIS.Display.IDisplayTransformation dspTrans2 = (Environment.MapControl.ActiveView as ESRI.ArcGIS.Carto.IActiveView).ScreenDisplay.DisplayTransformation;

                snp = new ArenaSnapping(Environment.MapControl, pElayer, 500, spatRefGeo, dspTrans);

                snp.Tolerance = Environment.MapControl.ActiveView.FocusMap.MapScale * 0.00025 * 3;
        ...
        {
            TreeNode Nd = new TreeNode(NdText) { Checked = pdmObj.VisibilityFlag };
        ...
        {
            TreeNode Nd = new TreeNode(pdmObj.GetObjectLabel()) { Checked = pdmObj.VisibilityFlag};
            Environment.SetObjectVisibility(pdmObj, pdmObj.VisibilityFlag);
