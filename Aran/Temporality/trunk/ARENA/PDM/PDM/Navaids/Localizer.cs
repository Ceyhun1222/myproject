...
namespace PDM
{
    ...
    public class Localizer : NavaidComponent
    {
        ...
        private double _localizer_Position;
        ...
        public override string TypeName
        {
            get
            {
                return PDM_ENUM.Localizer.ToString();
            }
        } 
        ...
        public override void CompileRow(ref IRow row)
        {
            ...
            findx = row.Fields.FindField("true_bearing"); if (findx >= 0) row.set_Value(findx, this.trueBearing);
            findx = row.Fields.FindField("MagBrg"); if (findx >= 0) row.set_Value(findx, this.MagBrg);
