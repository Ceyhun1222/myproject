...
namespace PDM
{
    ...
    public class WayPoint : PDMObject
    {
        ...
        public override string TypeName
        {
            get
            {
                return PDM_ENUM.WayPoint.ToString();
            }
        } 
        ...
        public override void CompileRow(ref IRow row)
        {
            ...
            findx = row.Fields.FindField("WayPointLat"); if (findx >= 0) row.set_Value(findx, this.Lat);
            findx = row.Fields.FindField("WayPointLon"); if (findx >= 0) row.set_Value(findx, this.Lon);
