...
namespace PDM
{
    public class FinalLeg : ProcedureLeg
    {
        ...
        private double _minimumBaroVnavTemperature;
        [PropertyOrder(30)]
        ...
        private double _courseOffsetAngle;
        [PropertyOrder(60)]
        ...
        private double _courseCentrelineDistance;
        [PropertyOrder(80)]
        ...
        private double _courseOffsetDistance;
        [PropertyOrder(100)]
        ...
        public override string TypeName
        {
            get
            {
                return PDM_ENUM.FinalLeg.ToString();
            }
        } 
