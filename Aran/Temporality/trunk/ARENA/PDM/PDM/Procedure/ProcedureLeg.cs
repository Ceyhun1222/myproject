...
namespace PDM
{
    ...
    public class ProcedureLeg : PDMObject
    {
        ...
        private double _altitudeOverrideATC;
        ...
        private BearingType _courseType;

        public BearingType CourseType
        {
        ...
        private double _lowerLimitAltitude;
        ...
        private double _upperLimitAltitude;
        ...
        public override string TypeName
        {
            get
            {
                return PDM_ENUM.ProcedureLeg.ToString();
            }
        } 
        ...
        public override bool StoreToDB(Dictionary<Type, ITable> AIRTRACK_TableDic)
        {
            ...
            try
            {
                ...
                findx = row.Fields.FindField("ArcCenterPontID"); if ((findx >= 0) && (this.ArcCentre != null)) row.set_Value(findx, this.ArcCentre.ID);
