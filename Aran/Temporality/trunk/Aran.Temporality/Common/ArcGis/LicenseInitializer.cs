...
namespace Aran.Temporality.Common.ArcGis
{
    public class LicenseInitializer
    {
        ...
        public void InitializeApplication(object[] p, esriLicenseExtensionCode[] esriLicenseExtensionCode)
        {
        ...
        public void ShutdownApplication()
        {
            ...
            if (ConfigUtil.UseEsri && _mAoInit != null)
            {
                foreach (KeyValuePair<esriLicenseExtensionCode, esriLicenseStatus> item in _mExtensionStatus)
                {
        ...
        /// </summary>
        public bool InitializeLowerProductFirst { get; set; } = true;
        ...
        public esriLicenseProductCode InitializedProduct
        {
            get
            {
                if (_mAoInit != null)
                {
                    ...
                    {
                        LogManager.GetLogger(typeof(LicenseInitializer)).Warn(ex, ex.Message);
                        return 0;
                    }
                }
                return 0;
        ...
        static void BindingArcGisRuntime(object sender, EventArgs e)
        {
            ...
            LogManager.GetLogger(typeof(LicenseInitializer)).Fatal("Invalid ArcGIS runtime binding. Application will shut down.");
