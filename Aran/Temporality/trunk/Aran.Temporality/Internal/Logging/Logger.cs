...
namespace Aran.Temporality.Internal.Logging
{
    internal class Logger: ILogger
    {
        ...
        public static LogLevel Convert(Common.Logging.LogLevel level)
        {
            switch (level)
            {
        ...
        public static Common.Logging.LogLevel Convert(LogLevel level)
        {
            if (level == LogLevel.Fatal)
            {
                return Common.Logging.LogLevel.Fatal;
            }
            ...
            {
                return Common.Logging.LogLevel.Trace;
            }
            return Common.Logging.LogLevel.Info;
        }
        ...
        public void Log<T>(Common.Logging.LogLevel level, T value)
        {
            _logger.Log(Convert(level), value);
        }

        public void Log<T>(Common.Logging.LogLevel level, IFormatProvider formatProvider, T value)
        {
            _logger.Log(Convert(level), formatProvider, value);
        }


        public void Log(Common.Logging.LogLevel level, Exception exception, [Localizable(false)] string message, params object[] args)
        {
            _logger.Log(Convert(level), exception, message, args);
        }

        public void Log(Common.Logging.LogLevel level, Exception exception, IFormatProvider formatProvider, [Localizable(false)] string message, params object[] args)
        {
            _logger.Log(Convert(level), exception, formatProvider, message, args);
        }

        public void Log(Common.Logging.LogLevel level, IFormatProvider formatProvider, [Localizable(false)] string message, params object[] args)
        {
            _logger.Log(Convert(level), formatProvider, message, args);
        }

        public void Log(Common.Logging.LogLevel level, [Localizable(false)] string message)
        {
            _logger.Log(Convert(level), message);
        }

        public void Log(Common.Logging.LogLevel level, [Localizable(false)] string message, params object[] args)
        {
            _logger.Log(Convert(level), message, args);
        }


        public void Log<TArgument>(Common.Logging.LogLevel level, IFormatProvider formatProvider, [Localizable(false)] string message, TArgument argument)
        {
            _logger.Log(Convert(level), formatProvider, message, argument);
        }

        public void Log<TArgument>(Common.Logging.LogLevel level, [Localizable(false)] string message, TArgument argument)
        {
            _logger.Log(Convert(level), message, argument);
        }

        public void Log<TArgument1, TArgument2>(Common.Logging.LogLevel level, IFormatProvider formatProvider, [Localizable(false)] string message, TArgument1 argument1, TArgument2 argument2)
        {
            _logger.Log(Convert(level), formatProvider, message, argument1, argument2);
        }

        public void Log<TArgument1, TArgument2>(Common.Logging.LogLevel level, [Localizable(false)] string message, TArgument1 argument1, TArgument2 argument2)
        {
            _logger.Log(Convert(level), message, argument1, argument2);
        }

        public void Log<TArgument1, TArgument2, TArgument3>(Common.Logging.LogLevel level, IFormatProvider formatProvider, [Localizable(false)] string message, TArgument1 argument1, TArgument2 argument2, TArgument3 argument3)
        {
            _logger.Log(Convert(level), formatProvider, message, argument1, argument2, argument3);
        }

        public void Log<TArgument1, TArgument2, TArgument3>(Common.Logging.LogLevel level, [Localizable(false)] string message, TArgument1 argument1, TArgument2 argument2, TArgument3 argument3)
        {
            _logger.Log(Convert(level), message, argument1, argument2, argument3);
        }

        public void Log(Common.Logging.LogLevel level, object value)
        {
            _logger.Log(Convert(level), value);
        }

        public void Log(Common.Logging.LogLevel level, IFormatProvider formatProvider, object value)
        {
            _logger.Log(Convert(level), formatProvider, value);
        }

        public void Log(Common.Logging.LogLevel level, string message, object arg1, object arg2)
        {
            _logger.Log(Convert(level), message, arg1, arg2);
        }

        public void Log(Common.Logging.LogLevel level, string message, object arg1, object arg2, object arg3)
        {
            _logger.Log(Convert(level), message, arg1, arg2, arg3);
        }

        public void Log(Common.Logging.LogLevel level, IFormatProvider formatProvider, string message, bool argument)
        {
            _logger.Log(Convert(level), formatProvider, message, argument);
        }

        public void Log(Common.Logging.LogLevel level, string message, bool argument)
        {
            _logger.Log(Convert(level), message, argument);
        }

        public void Log(Common.Logging.LogLevel level, IFormatProvider formatProvider, string message, char argument)
        {
            _logger.Log(Convert(level), formatProvider, message, argument);
        }

        public void Log(Common.Logging.LogLevel level, string message, char argument)
        {
            _logger.Log(Convert(level), message, argument);
        }

        public void Log(Common.Logging.LogLevel level, IFormatProvider formatProvider, string message, byte argument)
        {
            _logger.Log(Convert(level), formatProvider, message, argument);
        }

        public void Log(Common.Logging.LogLevel level, string message, byte argument)
        {
            _logger.Log(Convert(level), message, argument);
        }

        public void Log(Common.Logging.LogLevel level, IFormatProvider formatProvider, string message, string argument)
        {
            _logger.Log(Convert(level), formatProvider, message, argument);
        }

        public void Log(Common.Logging.LogLevel level, string message, string argument)
        {
            _logger.Log(Convert(level), message, argument);
        }

        public void Log(Common.Logging.LogLevel level, IFormatProvider formatProvider, string message, int argument)
        {
            _logger.Log(Convert(level), formatProvider, message, argument);
        }

        public void Log(Common.Logging.LogLevel level, string message, int argument)
        {
            _logger.Log(Convert(level), message, argument);
        }

        public void Log(Common.Logging.LogLevel level, IFormatProvider formatProvider, string message, long argument)
        {
            _logger.Log(Convert(level), formatProvider, message, argument);
        }

        public void Log(Common.Logging.LogLevel level, string message, long argument)
        {
            _logger.Log(Convert(level), message, argument);
        }

        public void Log(Common.Logging.LogLevel level, IFormatProvider formatProvider, string message, float argument)
        {
            _logger.Log(Convert(level), formatProvider, message, argument);
        }

        public void Log(Common.Logging.LogLevel level, string message, float argument)
        {
            _logger.Log(Convert(level), message, argument);
        }

        public void Log(Common.Logging.LogLevel level, IFormatProvider formatProvider, string message, double argument)
        {
            _logger.Log(Convert(level), formatProvider, message, argument);
        }

        public void Log(Common.Logging.LogLevel level, string message, double argument)
        {
            _logger.Log(Convert(level), message, argument);
        }

        public void Log(Common.Logging.LogLevel level, IFormatProvider formatProvider, string message, decimal argument)
        {
            _logger.Log(Convert(level), formatProvider, message, argument);
        }

        public void Log(Common.Logging.LogLevel level, string message, decimal argument)
        {
            _logger.Log(Convert(level), message, argument);
        }

        public void Log(Common.Logging.LogLevel level, IFormatProvider formatProvider, string message, object argument)
        {
            _logger.Log(Convert(level), formatProvider, message, argument);
        }

        public void Log(Common.Logging.LogLevel level, string message, object argument)
        {
            _logger.Log(Convert(level), message, argument);
        }

        public void Log(Common.Logging.LogLevel level, IFormatProvider formatProvider, string message, sbyte argument)
        {
            _logger.Log(Convert(level), formatProvider, message, argument);
        }

        public void Log(Common.Logging.LogLevel level, string message, sbyte argument)
        {
            _logger.Log(Convert(level), message, argument);
        }

        public void Log(Common.Logging.LogLevel level, IFormatProvider formatProvider, string message, uint argument)
        {
            _logger.Log(Convert(level), formatProvider, message, argument);
        }

        public void Log(Common.Logging.LogLevel level, string message, uint argument)
        {
            _logger.Log(Convert(level), message, argument);
        }

        public void Log(Common.Logging.LogLevel level, IFormatProvider formatProvider, string message, ulong argument)
        {
            _logger.Log(Convert(level), formatProvider, message, argument);
        }

        public void Log(Common.Logging.LogLevel level, string message, ulong argument)
        {
            _logger.Log(Convert(level), message, argument);
        }
