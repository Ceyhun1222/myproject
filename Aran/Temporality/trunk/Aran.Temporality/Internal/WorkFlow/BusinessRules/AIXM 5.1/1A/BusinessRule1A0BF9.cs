...
{
    internal class BusinessRule1A0BF9 : AbstractBusinessRule
    {
        ...
        public override bool CheckParent(object obj)
        {
            ...
            if (airSpaceVolume?.Centreline != null)
            {
        ...
        {
            return "It is prohibited that AirspaceVolume with assigned centreline value has assigned contributorAirspace value";
        }
