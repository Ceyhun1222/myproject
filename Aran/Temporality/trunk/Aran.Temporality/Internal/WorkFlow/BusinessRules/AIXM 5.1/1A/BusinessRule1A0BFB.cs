...
{
    internal class BusinessRule1A0BFB : AbstractBusinessRule
    {
        ...
        public override bool CheckParent(object obj)
        {
            ...
            {
                return airSpaceVolume.Centreline == null;
            }
            return true;
        }
        ...
        {
            return "It is prohibited that AirspaceVolume with assigned horizontalProjection value has assigned centreline value";
        }
