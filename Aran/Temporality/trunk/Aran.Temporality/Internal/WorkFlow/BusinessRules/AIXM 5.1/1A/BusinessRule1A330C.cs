...
{
    internal class BusinessRule1A330C : AbstractBusinessRule
    {
                public override string UID => "AIXM-5.1_RULE-1A330C";
        ...
        {
            return
                "Each MarkerBeacon shall have assigned frequency value";
        }
    }
}