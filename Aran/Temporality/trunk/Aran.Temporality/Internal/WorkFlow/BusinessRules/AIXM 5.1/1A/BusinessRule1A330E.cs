...
{
    internal class BusinessRule1A330E : AbstractBusinessRule
    {
                public override string UID => "AIXM-5.1_RULE-1A330E";

        public override bool CheckChild(object obj)
        {
            var item = obj as Route;
            return item?.DesignatorSecondLetter != null;
        ...
        {
            return
                "Each Route shall have assigned designatorSecondLetter value";
        }
    }
}