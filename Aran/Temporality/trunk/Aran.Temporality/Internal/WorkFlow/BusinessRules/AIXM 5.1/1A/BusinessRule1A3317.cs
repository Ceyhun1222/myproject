...
{
    internal class BusinessRule1A3317 : AbstractBusinessRule
    {
                public override string UID => "AIXM-5.1_RULE-1A3317";

        public override bool CheckChild(object obj)
        {
            var item = obj as RunwayDirection;
            return item?.UsedRunway != null && Load(FeatureType.Runway, item.UsedRunway) as Runway != null;
        }
        ...
        {
            return
                "Each RunwayDirection shall have assigned usedRunway value";
        }
    }
}