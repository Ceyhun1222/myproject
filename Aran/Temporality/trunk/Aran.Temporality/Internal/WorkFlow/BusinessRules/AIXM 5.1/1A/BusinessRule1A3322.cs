...
{
    internal class BusinessRule1A3322 : AbstractBusinessRule
    {
                public override string UID => "AIXM-5.1_RULE-1A3322";
        ...
        {
            return
                "Each AirportHeliport shall have assigned type value";
        }
    }
}