...
{
    internal class BusinessRule1A3328 : AbstractBusinessRule
    {
                public override string UID => "AIXM-5.1_RULE-1A3328";
        ...
        {
            return
                "Each VOR shall have assigned location.ElevatedPoint.pos value";
        }
    }
}