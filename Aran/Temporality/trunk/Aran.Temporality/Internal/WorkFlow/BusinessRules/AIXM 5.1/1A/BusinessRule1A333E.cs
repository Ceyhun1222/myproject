...
{
	internal class BusinessRule1A333E : AbstractBusinessRule
	{
				public override string UID => "AIXM-5.1_RULE-1A333E";
		...
		{
			return
				"Each NDB shall have assigned location.ElevatedPoint.pos value";
		}
	}
}
