...
{
	class BusinessRule1A3351 : AbstractBusinessRule
	{
				public override string UID => "AIXM-5.1_RULE-1A3351";

		public override bool CheckChild ( object obj )
		{
			var item = obj as RouteSegment;
			return item?.NavigationType != null;
		}
		...
		{
			return
				"Each RouteSegment shall have assigned navigationType value";
		}
	}
}