...
{
    class BusinessRule1A3358 : AbstractBusinessRule
    {
                public override string UID => "AIXM-5.1_RULE-1A3358";
        ...
        {
            return
                "Each MarkerBeacon shall have assigned location.ElevatedPoint.pos value";
        }
    }
}