...
{
    class BusinessRule1A335C : AbstractBusinessRule
    {
                public override string UID => "AIXM-5.1_RULE-1A335C";

        public override bool CheckChild ( object obj )
        {
            var item = obj as Unit;
            return item?.OwnerOrganisation != null
                 && Load(FeatureType.OrganisationAuthority, item.OwnerOrganisation) as OrganisationAuthority != null;
        }
