...
{
    class BusinessRule1A3389 : AbstractBusinessRule
    {
                public override string UID => "AIXM-5.1_RULE-1A3389";
        ...
        {
            return
                "Each TACAN shall have assigned location.ElevatedPoint.pos value";
        }
    }
}