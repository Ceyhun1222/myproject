...
{
    class BusinessRule1A3395 : AbstractBusinessRule
    {
                public override string UID => "AIXM-5.1_RULE-1A3395";

        public override bool CheckChild(object obj)
        {
            var item = obj as Route;
            return item?.DesignatorNumber != null;
        }
        ...
        {
            return
                "Each Route shall have assigned designatorNumber value";
        }
    }
}