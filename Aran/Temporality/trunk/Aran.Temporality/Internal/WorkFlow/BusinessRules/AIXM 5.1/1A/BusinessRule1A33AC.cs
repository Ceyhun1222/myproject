...
{
    class BusinessRule1A33AC : AbstractBusinessRule
    {
                public override string UID => "AIXM-5.1_RULE-1A33AC";

        public override bool CheckChild(object obj)
        {
            var item = obj as Runway;
            return item?.AssociatedAirportHeliport != null
                 && Load(FeatureType.AirportHeliport, item.AssociatedAirportHeliport) as AirportHeliport != null; 
        }
