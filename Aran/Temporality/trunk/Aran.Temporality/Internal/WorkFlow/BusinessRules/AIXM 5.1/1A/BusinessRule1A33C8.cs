...
{
	class BusinessRule1A33C8 : AbstractBusinessRule
	{
				public override string UID => "AIXM-5.1_RULE-1A33C8";

		public override bool CheckChild(object obj)
		{
			var item = obj as VOR;
			return item?.ZeroBearingDirection != null;
		}
		...
		{
			return
				"Each VOR shall have assigned zeroBearingDirection value";
		}
	}
}