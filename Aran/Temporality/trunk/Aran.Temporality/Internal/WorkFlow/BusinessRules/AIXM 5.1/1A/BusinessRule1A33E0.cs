...
{
	class BusinessRule1A33E0 : AbstractBusinessRule
	{
				public override string UID => "AIXM-5.1_RULE-1A33E0";

		public override bool CheckChild(object obj)
		{
			var item = obj as Airspace;
			return ( item?.GeometryComponent?.Count ?? 0 ) > 0;
		}
		...
		{
			return
				"Each Airspace shall have assigned geometryComponent value";
		}
	}
}