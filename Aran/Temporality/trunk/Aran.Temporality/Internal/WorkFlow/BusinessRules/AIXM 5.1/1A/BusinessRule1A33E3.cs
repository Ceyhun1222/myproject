...
{
	class BusinessRule1A33E3 : AbstractBusinessRule
	{
				public override string UID => "AIXM-5.1_RULE-1A33E3";
        ...
        public override bool CheckParent(object obj)
        {
            ...
            {
                return item.ContributorAirspace.Dependency != null;
            }
            return true;
        }
		...
		{
			return
				"Each AirspaceVolumeDependency shall have assigned dependency value";
		}
	}
}