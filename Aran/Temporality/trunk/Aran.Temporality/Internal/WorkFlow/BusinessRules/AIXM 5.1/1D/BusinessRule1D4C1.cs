...
{
    internal class BusinessRule1D4C1 : AbstractBusinessRule
    {
        ...
        public override bool CheckParent(object obj)
        {
            ...
            {
                return airSpaceVolume.UpperLimit == null;
            }
            return true;
        }
        ...
        {
            return "Each AirspaceVolume with contributorAirspace.AirspaceVolumeDependency.dependency value equal-to 'FULL_GEOMETRY' shall not have assigned upperLimit";
        }
