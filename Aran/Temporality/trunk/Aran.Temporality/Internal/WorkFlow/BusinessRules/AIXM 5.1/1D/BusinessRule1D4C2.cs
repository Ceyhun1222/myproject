...
{
    internal class BusinessRule1D4C2 : AbstractBusinessRule
    {
        ...
        public override bool CheckParent(object obj)
        {
            ...
            {
                return airSpaceVolume.MinimumLimit == null;
            }
            return true;
        }
        ...
        {
            return "Each AirspaceVolume with contributorAirspace.AirspaceVolumeDependency.dependency value equal-to 'FULL_GEOMETRY' shall not have assigned minimumLimit";
        }
