...
{
    internal class BusinessRule1D4C4 : AbstractBusinessRule
    {
        ...
        public override bool CheckParent(object obj)
        {
            ...
            {
                return airSpaceVolume.MaximumLimit == null;
            }
            return true;
        }
        ...
        {
            return "Each AirspaceVolume with contributorAirspace.AirspaceVolumeDependency.dependency value equal-to 'FULL_GEOMETRY' shall not have assigned maximumLimit";
        }
