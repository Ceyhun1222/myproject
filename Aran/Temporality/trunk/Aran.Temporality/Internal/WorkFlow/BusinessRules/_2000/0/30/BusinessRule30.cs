...
{
    internal class BusinessRule30 : AbstractBusinessRule
    {
        #region Overrides of AbstractBusinessRule

        public override bool CheckChild(object obj)
        {
            var item = obj as NavaidEquipmentDistance;
            ...
            {
                return item.Distance.Uom == UomDistance.KM ||
                       item.Distance.Uom == UomDistance.CM ||
                       item.Distance.Uom == UomDistance.M;
        ...
        {
            return typeof (NavaidEquipmentDistance);
        }
