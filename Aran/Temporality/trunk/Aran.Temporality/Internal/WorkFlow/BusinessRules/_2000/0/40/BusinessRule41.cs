...
{
    internal class BusinessRule41 : AbstractBusinessRule
    {
        #region Overrides of AbstractBusinessRule

        public override bool CheckChild(object obj)
        {
            var item = obj as RunwayContamination;
            if (item == null) return false;
            var temp = item.FurtherClearanceLength;
            if (temp != null)
        ...
        {
            return typeof(RunwayContamination);
        }
