...
{
    internal class BusinessRule79 : AbstractBusinessRule
    {
        #region Overrides of AbstractBusinessRule

        public override bool CheckChild(object obj)
        {
            var item = obj as MissedApproachGroup;
            if (item == null) return false;
            var temp = item.AlternateClimbAltitude;
            if (temp != null)
        ...
        {
            return typeof(MissedApproachGroup);
        }
