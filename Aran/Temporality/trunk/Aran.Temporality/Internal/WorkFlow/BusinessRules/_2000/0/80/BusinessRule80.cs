...
{
    internal class BusinessRule80 : AbstractBusinessRule
    {
        ...
        public override bool CheckChild(object obj)
        {
            ...
            if (item.ThresholdCourseWidth!=null)
            {
                return item.ThresholdCourseWidth.Uom == UomDistance.M ||
                       item.ThresholdCourseWidth.Uom == UomDistance.KM ||
                       item.ThresholdCourseWidth.Uom == UomDistance.CM;
            }
