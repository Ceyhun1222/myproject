...
{
    internal class BusinessRule108 : AbstractBusinessRule
    {
        #region Overrides of AbstractBusinessRule

        public override bool CheckChild(object obj)
        {
            var item = obj as AltitudeAdjustment;
            if (item == null) return false;
            var temp = item.AltitudeAdjustmentP;
            if (temp != null)
        ...
        {
            return typeof(AltitudeAdjustment);
        }
