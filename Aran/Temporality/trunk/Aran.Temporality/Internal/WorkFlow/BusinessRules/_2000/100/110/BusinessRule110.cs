...
{
    internal class BusinessRule110 : AbstractBusinessRule
    {
        #region Overrides of AbstractBusinessRule

        public override bool CheckChild(object obj)
        {
            var item = obj as ObstacleAssessmentArea;
            if (item == null) return false;
            var temp = item.SlopeLowerAltitude;
            if (temp != null)
        ...
        {
            return typeof(ObstacleAssessmentArea);
        }
