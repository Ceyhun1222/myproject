...
{
    internal class BusinessRule111 : AbstractBusinessRule
    {
        #region Overrides of AbstractBusinessRule

        public override bool CheckChild(object obj)
        {
            var item = obj as ObstaclePlacement;
            if (item == null) return false;
            var temp = item.ObstacleDistance; if (temp != null)
        ...
        {
            return typeof(ObstaclePlacement);
        }
