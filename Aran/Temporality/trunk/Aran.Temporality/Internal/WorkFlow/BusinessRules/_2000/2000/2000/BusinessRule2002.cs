...
{
    internal class BusinessRule2002 : AbstractBusinessRule
    {
        ...
        public override bool CheckChild(object obj)
        {
            ...
            var segmentsStarting = Context.GetLinks(false, FeatureType.RouteSegment, item, "Start/PointChoice/FixDesignatedPoint").Cast<RouteSegment>().ToList();
            var segmentsEnding = Context.GetLinks(false, FeatureType.RouteSegment, item, "End/PointChoice/FixDesignatedPoint").Cast<RouteSegment>().ToList();
