...
{
    class BusinessRule2005 : AbstractBusinessRule
    {
        ...
        public override bool CheckChild(object obj)
        {
            ...
            var segmentsStarting = Context.GetLinks(false, FeatureType.RouteSegment, item, "Start/PointChoice/RunwayPoint").Cast<RouteSegment>().ToList();
            var segmentsEnding = Context.GetLinks(false, FeatureType.RouteSegment, item, "End/PointChoice/RunwayPoint").Cast<RouteSegment>().ToList();
