...
{
    class BusinessRule2006 : AbstractBusinessRule
    {
        ...
        public override bool CheckChild(object obj)
        {
            ...
            var segmentsStarting = Context.GetLinks(false, FeatureType.RouteSegment, item, "Start/PointChoice/AirportReferencePoint").Cast<RouteSegment>().ToList();
            var segmentsEnding = Context.GetLinks(false, FeatureType.RouteSegment, item, "End/PointChoice/AirportReferencePoint").Cast<RouteSegment>().ToList();
