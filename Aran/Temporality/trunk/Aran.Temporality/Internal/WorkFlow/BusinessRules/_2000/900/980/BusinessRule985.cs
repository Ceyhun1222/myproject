...
{
    internal class BusinessRule985 : AbstractBusinessRule
    {
        #region Overrides of AbstractBusinessRule

        public override bool CheckChild(object obj)
        {
            var item = obj as RunwayProtectArea;
            if (item == null) return false;

            //"Each AirportHeliportProtectionArea.width should have a resolution matching 1m";
            
            //in schematron there is another rule- resolution should be 1m or 1 ft
            //see comments
        ...
        {
            return typeof (RunwayProtectArea);
        }
