...
namespace Aran.Temporality.CommonUtil.DataVirtualization
{
        ...
        IDisposable
    {
        ...
        /// </summary>
        [field: NonSerialized()] private static readonly NotifyCollectionChangedEventHandler _emptyDelegate =
            delegate { };
        ...
        /// 
        /// </summary>
        [field: NonSerialized()] private ReentryMonitor _monitor = new ReentryMonitor();

        /// <summary>
        /// Placeholder for all data related to delayed 
        /// notifications.
        /// </summary>
        [field: NonSerialized()] private NotificationInfo _notifyInfo;
        ...
        [field: NonSerialized()] private Action FireCountAndIndexerChanged = delegate { };

        [field: NonSerialized()] private Action FireIndexerChanged = delegate { };
            ...
            if (null != _notifyInfo)
            {
                if (_notifyInfo.HasEventArgs)
                {
                    ...
                    using (_notifyInfo.RootCollection.BlockReentrancy())
                    {
                        ...
                        foreach (
                            Delegate delegateItem in _notifyInfo.RootCollection.CollectionChanged.GetInvocationList())
                        {
                            try
                            {
