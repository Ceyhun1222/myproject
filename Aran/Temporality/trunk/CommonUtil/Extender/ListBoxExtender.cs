...
namespace Aran.Temporality.CommonUtil.Extender
{
    ...
    public class ListBoxExtender : DependencyObject
    {
        ...
        public static readonly DependencyProperty AutoScrollToCurrentItemProperty = DependencyProperty.RegisterAttached("AutoScrollToCurrentItem", typeof(bool), typeof(ListBoxExtender), new UIPropertyMetadata(default(bool), OnAutoScrollToCurrentItemChanged));
