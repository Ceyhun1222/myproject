...
namespace TOSSM.Geometry
{
    ...
    {
        public static List<Point> GetBorderPoints(Aran.Geometries.Geometry geometry)
        {
        ...
        static Dictionary<Aran.Geometries.Geometry, Circle> cach = new Dictionary<Aran.Geometries.Geometry, Circle>();

        public static bool GetExtend(Aran.Geometries.Geometry geometry,out double minX, out double minY, out double maxX, out double maxY)
        {
            minX = 0;
            minY = 0;
            maxX = 0;
        ...
        public static void Simplify(Aran.Geometries.Geometry geometry, out Point center, out double radius)
        {
            radius = 0;
            center = null;
