...
namespace TOSSM.View.Control
{
    ...
    public partial class FilteredComboBox : ComboBox
    {
        ...
        /// </remarks>
        protected TextBox EditableTextBox => this.GetTemplateChild("PART_EditableTextBox") as TextBox;
        ...
        private bool FilterPredicate(object value)
        {
            ...
            if (value.GetType().GetProperties().Any(t => t.Name.Equals(DisplayMemberPath)))
            {
                var prop = value.GetType().GetProperties().First(t => t.Name.Equals(DisplayMemberPath));
                var val = prop.GetValue(value);
                if (val == null)
                    return false;
                else
                {
                    return val.ToString().ToLower().StartsWith(this.Text.ToLower());
                }
            }
            else
                return value.ToString().ToLower().StartsWith(this.Text.ToLower());
        }
    }
}
