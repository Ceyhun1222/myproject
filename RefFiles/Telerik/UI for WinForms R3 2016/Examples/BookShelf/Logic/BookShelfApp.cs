...
namespace BookShelf
{
    public class BookShelfApp
    {
        ...
        public string FileName
        {
            get
            {
                return Path.Combine(Path.GetDirectoryName(Application.ExecutablePath), Settings.Default.CacheFileName);
            }
        }
        ...
        public string BackUpFileName
        {
            get
            {
                return Path.Combine(Path.GetDirectoryName(Application.ExecutablePath), Settings.Default.BackUpFileName);
            }
        }
        ...
        void LoadDataWorkItem(object threadContext)
        {
            if (!DeserializeData(FileName))
            {
                ...
                catch
                {
                    ...
                    DeserializeData(BackUpFileName);
                }
