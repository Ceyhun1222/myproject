...
namespace BookShelf
{
    public partial class MainForm : RadForm
    {
        ...
        void InitializeWaitingBar()
        {
            ...
            waitingBar.WaitingBarElement.Indicators[0].GradientStyle = Telerik.WinControls.GradientStyles.Solid;
            waitingBar.WaitingBarElement.Indicators[0].BackColor = Color.FromArgb(217, 71, 0);
            waitingBar.WaitingBarElement.Indicators[1].GradientStyle = Telerik.WinControls.GradientStyles.Solid;
            waitingBar.WaitingBarElement.Indicators[1].BackColor = Color.FromArgb(217, 71, 0);
