...
namespace BugTracker
{
    partial class RadAboutBox1 : Telerik.WinControls.UI.RadForm
    {
        public RadAboutBox1()
        {
            ...
            this.radTextBoxDescription.Text = "This demo application is created by Telerik and it demonstrates part of the Telerik UI for WinForms suite";

            this.okRadButton.Click += new EventHandler(okRadButton_Click);
        }

        void okRadButton_Click(object sender, EventArgs e)
        {
            this.Close();
        }
