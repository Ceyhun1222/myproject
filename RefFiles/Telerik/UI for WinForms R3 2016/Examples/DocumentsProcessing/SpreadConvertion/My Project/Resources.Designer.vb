...
'		}
		...
		''' </summary>
		Friend ReadOnly Property CustomDocumentImage() As Bitmap
			Get
		...
		'''   Looks up a localized resource of type System.Drawing.Bitmap.
		''' </summary>
		Friend ReadOnly Property SampleDocumentImage() As Bitmap
			Get
				Dim obj As Object = ResourceManager.GetObject("SampleDocumentImage", resourceCulture)
				Return (CType(obj, Bitmap))
			End Get
		End Property
	End Module
