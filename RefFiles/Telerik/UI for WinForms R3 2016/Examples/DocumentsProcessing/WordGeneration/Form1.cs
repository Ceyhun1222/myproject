...
namespace WordGeneration
{
    public partial class Form1 : RadForm
    {
        ...
        private void CreateSignature(RadFlowDocumentEditor editor)
        {
            ...
            using (Stream stream = FileHelper.GetSampleResourceStream("WordGeneration.Resources.progress-logo.png"))
            {
        ...
        private void CreateHeader(RadFlowDocumentEditor editor)
        {
            if (this.IncludeHeader)
            {
                ...
                using (Stream stream = FileHelper.GetSampleResourceStream("WordGeneration.Resources.progress-big-logo.png"))
                {
