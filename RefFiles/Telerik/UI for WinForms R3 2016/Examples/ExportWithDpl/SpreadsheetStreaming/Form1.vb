...
Namespace ExportWithDpl.SpreadsheetStreaming
	Public Partial Class Form1
		...
		Private Sub AddBindings()
			...
			Me.radLabelExportTimeElapsed.DataBindings.Add("Text", Me.viewModel, "ExportTime", True, DataSourceUpdateMode.OnPropertyChanged, 0R, "F2")

			Me.radLabelMemory.DataBindings.Add("Text", Me.viewModel, "Memory", True, DataSourceUpdateMode.OnPropertyChanged, 0R, "F2")
