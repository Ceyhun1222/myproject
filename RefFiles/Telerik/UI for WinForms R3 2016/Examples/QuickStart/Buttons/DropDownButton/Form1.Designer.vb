Namespace Telerik.Examples.WinControls.Buttons.DropDownButton
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.menuImages = New ImageList(Me.components)
			...
			Me.radPanelDemoHolder.Size = New Size(510, 292)
			' 
			' settingsPanel
			' 
			...
			Me.radDropDown1.ImageAlignment = ContentAlignment.BottomCenter
			...
			Me.radDropDown1.Location = New Point(156, 58)
			...
			Me.radDropDown1.Size = New Size(140, 52)
			Me.radDropDown1.TabIndex = 0
			Me.radDropDown1.Text = "Move to folder"
			Me.radDropDown1.TextImageRelation = TextImageRelation.ImageBeforeText
			CType(Me.radDropDown1.GetChildAt(0), Telerik.WinControls.UI.RadDropDownButtonElement).TextImageRelation = TextImageRelation.ImageBeforeText
			CType(Me.radDropDown1.GetChildAt(0), Telerik.WinControls.UI.RadDropDownButtonElement).ImageAlignment = ContentAlignment.BottomCenter
			CType(Me.radDropDown1.GetChildAt(0), Telerik.WinControls.UI.RadDropDownButtonElement).DisplayStyle = Telerik.WinControls.DisplayStyle.Text
			CType(Me.radDropDown1.GetChildAt(0), Telerik.WinControls.UI.RadDropDownButtonElement).Text = "Move to folder"
			CType(Me.radDropDown1.GetChildAt(0), Telerik.WinControls.UI.RadDropDownButtonElement).CanFocus = True
			CType(Me.radDropDown1.GetChildAt(0).GetChildAt(1).GetChildAt(1), Telerik.WinControls.UI.ActionButtonElement).Padding = New Padding(4)
			' 
			' menuImages
			' 
			Me.menuImages.ImageStream = (CType(resources.GetObject("menuImages.ImageStream"), ImageListStreamer))
			Me.menuImages.TransparentColor = Color.Lime
			...
			Me.radMenuItem25.TextImageRelation = TextImageRelation.ImageBeforeText
			...
			Me.radMenuItem26.TextImageRelation = TextImageRelation.ImageBeforeText
			...
			Me.radMenuItem27.TextImageRelation = TextImageRelation.ImageBeforeText
			...
			Me.radMenuItem28.TextImageRelation = TextImageRelation.ImageBeforeText
			...
			Me.radMenuItem29.TextImageRelation = TextImageRelation.ImageBeforeText
			...
			Me.radMenuItem30.TextImageRelation = TextImageRelation.ImageBeforeText
			...
			' radMenuItem18
			' 
			Me.radMenuItem18.AccessibleDescription = "Word Document" & vbCrLf & "Save the document in the default file format."
			Me.radMenuItem18.AccessibleName = "Word Document" & vbCrLf & "Save the document in the default file format."
			Me.radMenuItem18.ImageIndex = 9
			Me.radMenuItem18.Name = "radMenuItem18"
			Me.radMenuItem18.Text = "Word Document" & vbCrLf & "Save the document in the default file format."
			...
			' radMenuItem19
			' 
			Me.radMenuItem19.AccessibleDescription = "Word Template" & vbCrLf & "Save the document as a template that can be used to format future " & "documents."
			Me.radMenuItem19.AccessibleName = "Word Template" & vbCrLf & "Save the document as a template that can be used to format future " & "documents."
			Me.radMenuItem19.ImageIndex = 10
			Me.radMenuItem19.Name = "radMenuItem19"
			Me.radMenuItem19.Text = "Word Template" & vbCrLf & "Save the document as a template that can be used to format future " & "documents."
			...
			' radMenuItem20
			' 
			Me.radMenuItem20.AccessibleDescription = "Word 97-2003 Document" & vbCrLf & "Save a copy of the document that is fully compatible with " & "Word 97-2003."
			Me.radMenuItem20.AccessibleName = "Word 97-2003 Document" & vbCrLf & "Save a copy of the document that is fully compatible with " & "Word 97-2003."
			Me.radMenuItem20.ImageIndex = 11
			Me.radMenuItem20.Name = "radMenuItem20"
			Me.radMenuItem20.Text = "Word 97-2003 Document" & vbCrLf & "Save a copy of the document that is fully compatible with " & "Word 97-2003."
			...
			' radMenuItem21
			' 
			Me.radMenuItem21.AccessibleDescription = "Find add-ins for other file formats" & vbCrLf & "Learn about add-ins to save to other formats" & " such as PDF or XPS."
			Me.radMenuItem21.AccessibleName = "Find add-ins for other file formats" & vbCrLf & "Learn about add-ins to save to other formats" & " such as PDF or XPS."
			Me.radMenuItem21.ImageIndex = 12
			Me.radMenuItem21.Name = "radMenuItem21"
			Me.radMenuItem21.Text = "Find add-ins for other file formats" & vbCrLf & "Learn about add-ins to save to other formats" & " such as PDF or XPS."
			Me.radMenuItem21.TextImageRelation = TextImageRelation.ImageBeforeText
			Me.radMenuItem21.Visibility = Telerik.WinControls.ElementVisibility.Visible
			' 
			' radMenuItem22
			' 
			Me.radMenuItem22.AccessibleDescription = "Other Formats" & vbCrLf & "Open the Save As dialog box to select from all possible file types" & "." & vbCrLf
			Me.radMenuItem22.AccessibleName = "Other Formats" & vbCrLf & "Open the Save As dialog box to select from all possible file types" & "." & vbCrLf
			Me.radMenuItem22.ImageIndex = 13
			Me.radMenuItem22.Name = "radMenuItem22"
			Me.radMenuItem22.Text = "Other Formats" & vbCrLf & "Open the Save As dialog box to select from all possible file types" & "." & vbCrLf
			...
			' radMenuItem31
			' 
			Me.radMenuItem31.AccessibleDescription = "Print" & vbCrLf & "Select a printer, number of copies, and other printing options before prin" & "ting."
			Me.radMenuItem31.AccessibleName = "Print" & vbCrLf & "Select a printer, number of copies, and other printing options before prin" & "ting."
			Me.radMenuItem31.ImageIndex = 14
			Me.radMenuItem31.Name = "radMenuItem31"
			Me.radMenuItem31.Text = "Print" & vbCrLf & "Select a printer, number of copies, and other printing options before prin" & "ting."
			Me.radMenuItem31.TextImageRelation = TextImageRelation.ImageBeforeText
			Me.radMenuItem31.Visibility = Telerik.WinControls.ElementVisibility.Visible
			' 
			' radMenuItem32
			' 
			Me.radMenuItem32.AccessibleDescription = "Quick Print" & vbCrLf & "Send the document directly to the default printer without making cha" & "nges."
			Me.radMenuItem32.AccessibleName = "Quick Print" & vbCrLf & "Send the document directly to the default printer without making cha" & "nges."
			Me.radMenuItem32.ImageIndex = 15
			Me.radMenuItem32.Name = "radMenuItem32"
			Me.radMenuItem32.Text = "Quick Print" & vbCrLf & "Send the document directly to the default printer without making cha" & "nges."
			Me.radMenuItem32.TextImageRelation = TextImageRelation.ImageBeforeText
			Me.radMenuItem32.Visibility = Telerik.WinControls.ElementVisibility.Visible
			' 
			' radMenuItem33
			' 
			Me.radMenuItem33.AccessibleDescription = "Print Preview" & vbCrLf & "Preview and make changes to pages before printing."
			Me.radMenuItem33.AccessibleName = "Print Preview" & vbCrLf & "Preview and make changes to pages before printing."
			Me.radMenuItem33.ImageIndex = 16
			Me.radMenuItem33.Name = "radMenuItem33"
			Me.radMenuItem33.Text = "Print Preview" & vbCrLf & "Preview and make changes to pages before printing."
			Me.radMenuItem33.TextImageRelation = TextImageRelation.ImageBeforeText
			...
			' radMenuItem34
			' 
			Me.radMenuItem34.AccessibleDescription = "Properties" & vbCrLf & "View and edit document properties, such as Title, Author, and Keyword" & "s."
			Me.radMenuItem34.AccessibleName = "Properties" & vbCrLf & "View and edit document properties, such as Title, Author, and Keyword" & "s."
			Me.radMenuItem34.ImageIndex = 17
			Me.radMenuItem34.Name = "radMenuItem34"
			Me.radMenuItem34.Text = "Properties" & vbCrLf & "View and edit document properties, such as Title, Author, and Keyword" & "s."
			...
			' radMenuItem35
			' 
			Me.radMenuItem35.AccessibleDescription = "Inspect Document" & vbCrLf & "Check the document for hidden metadata or personal information." & ""
			Me.radMenuItem35.AccessibleName = "Inspect Document" & vbCrLf & "Check the document for hidden metadata or personal information." & ""
			Me.radMenuItem35.ImageIndex = 18
			Me.radMenuItem35.Name = "radMenuItem35"
			Me.radMenuItem35.Text = "Inspect Document" & vbCrLf & "Check the document for hidden metadata or personal information." & ""
			...
			' radMenuItem36
			' 
			Me.radMenuItem36.AccessibleDescription = "Encrypt Document" & vbCrLf & "Increase the security of the document by adding encryption."
			Me.radMenuItem36.AccessibleName = "Encrypt Document" & vbCrLf & "Increase the security of the document by adding encryption."
			Me.radMenuItem36.ImageIndex = 19
			Me.radMenuItem36.Name = "radMenuItem36"
			Me.radMenuItem36.Text = "Encrypt Document" & vbCrLf & "Increase the security of the document by adding encryption."
			...
			' radMenuItem37
			' 
			Me.radMenuItem37.AccessibleDescription = "Restrict Permission" & vbCrLf & "Grant people access while restricting their ability to edit," & " copy, and print."
			Me.radMenuItem37.AccessibleName = "Restrict Permission" & vbCrLf & "Grant people access while restricting their ability to edit," & " copy, and print."
			...
			Me.radMenuItem37.Text = "Restrict Permission" & vbCrLf & "Grant people access while restricting their ability to edit," & " copy, and print."
			Me.radMenuItem37.TextImageRelation = TextImageRelation.ImageBeforeText
			...
			Me.radMenuItem46.TextImageRelation = TextImageRelation.ImageBeforeText
			...
			Me.radMenuItem47.TextImageRelation = TextImageRelation.ImageBeforeText
			...
			' radMenuItem38
			' 
			Me.radMenuItem38.AccessibleDescription = "Add a Digital Signature" & vbCrLf & "Ensure the integrity of the document by adding an invisi" & "ble digital signature."
			Me.radMenuItem38.AccessibleName = "Add a Digital Signature" & vbCrLf & "Ensure the integrity of the document by adding an invisi" & "ble digital signature."
			Me.radMenuItem38.ImageIndex = 21
			Me.radMenuItem38.Name = "radMenuItem38"
			Me.radMenuItem38.Text = "Add a Digital Signature" & vbCrLf & "Ensure the integrity of the document by adding an invisi" & "ble digital signature."
			Me.radMenuItem38.TextImageRelation = TextImageRelation.ImageBeforeText
			Me.radMenuItem38.Visibility = Telerik.WinControls.ElementVisibility.Visible
			' 
			' radMenuItem39
			' 
			Me.radMenuItem39.AccessibleDescription = "Mark as Final" & vbCrLf & "Let readers know the document is final and make it read-only."
			Me.radMenuItem39.AccessibleName = "Mark as Final" & vbCrLf & "Let readers know the document is final and make it read-only."
			Me.radMenuItem39.ImageIndex = 22
			Me.radMenuItem39.Name = "radMenuItem39"
			Me.radMenuItem39.Text = "Mark as Final" & vbCrLf & "Let readers know the document is final and make it read-only."
			Me.radMenuItem39.TextImageRelation = TextImageRelation.ImageBeforeText
			Me.radMenuItem39.Visibility = Telerik.WinControls.ElementVisibility.Visible
			' 
			' radMenuItem40
			' 
			Me.radMenuItem40.AccessibleDescription = "Run Compatibility Checker" & vbCrLf & "Check for features not supported by earlier versions o" & "f Word."
			Me.radMenuItem40.AccessibleName = "Run Compatibility Checker" & vbCrLf & "Check for features not supported by earlier versions o" & "f Word."
			Me.radMenuItem40.ImageIndex = 23
			Me.radMenuItem40.Name = "radMenuItem40"
			Me.radMenuItem40.Text = "Run Compatibility Checker" & vbCrLf & "Check for features not supported by earlier versions o" & "f Word."
			Me.radMenuItem40.TextImageRelation = TextImageRelation.ImageBeforeText
			...
			' radMenuItem41
			' 
			Me.radMenuItem41.AccessibleDescription = "E-mail" & vbCrLf & "Send a copy of the document in an e-mail message as an attachment."
			Me.radMenuItem41.AccessibleName = "E-mail" & vbCrLf & "Send a copy of the document in an e-mail message as an attachment."
			Me.radMenuItem41.ImageIndex = 24
			Me.radMenuItem41.Name = "radMenuItem41"
			Me.radMenuItem41.Text = "E-mail" & vbCrLf & "Send a copy of the document in an e-mail message as an attachment."
			...
			' radMenuItem42
			' 
			Me.radMenuItem42.AccessibleDescription = "Internet Fax" & vbCrLf & "Use an Internet fax service to fax the document."
			Me.radMenuItem42.AccessibleName = "Internet Fax" & vbCrLf & "Use an Internet fax service to fax the document."
			Me.radMenuItem42.ImageIndex = 25
			Me.radMenuItem42.Name = "radMenuItem42"
			Me.radMenuItem42.Text = "Internet Fax" & vbCrLf & "Use an Internet fax service to fax the document."
			Me.radMenuItem42.TextImageRelation = TextImageRelation.ImageBeforeText
			...
			' radMenuItem43
			' 
			Me.radMenuItem43.AccessibleDescription = "Blog" & vbCrLf & "Create a new blog post with the content of the document."
			Me.radMenuItem43.AccessibleName = "Blog" & vbCrLf & "Create a new blog post with the content of the document."
			Me.radMenuItem43.ImageIndex = 26
			Me.radMenuItem43.Name = "radMenuItem43"
			Me.radMenuItem43.Text = "Blog" & vbCrLf & "Create a new blog post with the content of the document."
			Me.radMenuItem43.TextImageRelation = TextImageRelation.ImageBeforeText
			Me.radMenuItem43.Visibility = Telerik.WinControls.ElementVisibility.Visible
			' 
			' radMenuItem44
			' 
			Me.radMenuItem44.AccessibleDescription = "Document Management Server" & vbCrLf & "Share the document by saving it to a document managem" & "ent server."
			Me.radMenuItem44.AccessibleName = "Document Management Server" & vbCrLf & "Share the document by saving it to a document managem" & "ent server."
			Me.radMenuItem44.ImageIndex = 27
			Me.radMenuItem44.Name = "radMenuItem44"
			Me.radMenuItem44.Text = "Document Management Server" & vbCrLf & "Share the document by saving it to a document managem" & "ent server."
			Me.radMenuItem44.TextImageRelation = TextImageRelation.ImageBeforeText
			Me.radMenuItem44.Visibility = Telerik.WinControls.ElementVisibility.Visible
			' 
			' radMenuItem45
			' 
			Me.radMenuItem45.AccessibleDescription = "Create Document Workspace" & vbCrLf & "Create a new site for the document and keep the local " & "copy synchronized."
			Me.radMenuItem45.AccessibleName = "Create Document Workspace" & vbCrLf & "Create a new site for the document and keep the local " & "copy synchronized."
			Me.radMenuItem45.ImageIndex = 28
			Me.radMenuItem45.Name = "radMenuItem45"
			Me.radMenuItem45.Text = "Create Document Workspace" & vbCrLf & "Create a new site for the document and keep the local " & "copy synchronized."
			Me.radMenuItem45.TextImageRelation = TextImageRelation.ImageBeforeText
			...
			Me.radMenuSeparatorItem1.Bounds = New Rectangle(0, 424, 60, 1)
			Me.radMenuSeparatorItem1.Name = "radMenuSeparatorItem1"
			Me.radMenuSeparatorItem1.PositionOffset = New SizeF(50F, 0F)
			...
			Me.radDropDownImageOnly.ImageAlignment = ContentAlignment.MiddleCenter
			...
			Me.radDropDownImageOnly.Location = New Point(156, 0)
			...
			Me.radDropDownImageOnly.Size = New Size(140, 52)
			Me.radDropDownImageOnly.TabIndex = 4
			Me.radDropDownImageOnly.Text = "radDropDown2"
			Me.radDropDownImageOnly.TextImageRelation = TextImageRelation.ImageBeforeText
			' 
			' radLabel1
			' 
			Me.radLabel1.Location = New Point(-1, 19)
			Me.radLabel1.Name = "radLabel1"
			Me.radLabel1.Size = New Size(127, 18)
			Me.radLabel1.TabIndex = 10
			Me.radLabel1.Text = "Image Only Drop Down:"
			' 
			' radLabel2
			' 
			Me.radLabel2.Location = New Point(-1, 77)
			Me.radLabel2.Name = "radLabel2"
			Me.radLabel2.Size = New Size(116, 18)
			Me.radLabel2.TabIndex = 10
			Me.radLabel2.Text = "Text Only Drop Down:"
			' 
			' radLabel3
			' 
			Me.radLabel3.Location = New Point(-1, 135)
			Me.radLabel3.Name = "radLabel3"
			Me.radLabel3.Size = New Size(148, 18)
			Me.radLabel3.TabIndex = 10
			Me.radLabel3.Text = "Image And Text Drop Down:"
			' 
			' radDropDownButton1
			' 
			Me.radDropDownButton1.ImageAlignment = ContentAlignment.MiddleCenter
			...
			Me.radDropDownButton1.Location = New Point(156, 116)
		...
		Private menuImages As ImageList
