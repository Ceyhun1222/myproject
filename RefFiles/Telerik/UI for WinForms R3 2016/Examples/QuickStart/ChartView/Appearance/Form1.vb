...
Namespace Telerik.Examples.WinControls.ChartView.Appearance
    ...
    Partial Public Class Form1
        ...
        Private Sub InitializeRadarChart()
            ...
            polarAxis.Minimum = 0.0R
            polarAxis.Maximum = 5.0R
            ...
            radarLineSeries1.PointSize = New SizeF(1.0F, 1.0F)
            radarLineSeries2.PointSize = New SizeF(1.0F, 1.0F)
            radarAreaSeries1.PointSize = New SizeF(1.0F, 1.0F)
