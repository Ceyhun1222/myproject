...
Namespace Telerik.Examples.WinControls.ChartView.CartesianAnnotations
	Public Partial Class Form1
		...
		Public Sub New()
			...
			Dim axis As DateTimeContinuousAxis = New DateTimeContinuousAxis()
			...
			For Each ev As CompanyEvent In Me.model.GetGoogleEventData()
				Dim ann As CartesianGridLineAnnotation = New CartesianGridLineAnnotation(CType(Me.radChartView1.Axes(0), CartesianAxis), ev.TimeOfEvent)
