...
Namespace Telerik.Examples.WinControls.ChartView.ChartTypes.StockSeries
    Partial Public Class Form1
        ...
        Private Sub InitializeData()
            ...
            chartTypes = New List(Of String)(New String() {"OHLC", "HLC", "Candlestick"})

            movingAverageIndicators = New List(Of String)(New String() {"MA (5)", "Exponential MA (5)", "Modified MA (5)", "Modified Exponential MA (5)", "Weighted MA (5)", "Adaptive MA Kaufman (10,4,2)", "Bollinger Bands (5,2)"})

            financialIndicators = New List(Of String)(New String() {"Average True Range (5)", "Commodity Channel Index (5)", "MACD (12, 9, 6)", "Momentum (5)", "Oscillator (8, 4)", "RAVI (8, 4)", "Rate Of Change (8)", "Relative Momentum Index (8)", "Relative Strength Index (8)", "Stochastic Fast (14, 3)", "Stochastic Slow (14, 3, 3)", "TRIX (8)", "True Range", "Ultimate Oscillator (6, 9, 12)"})
        End Sub
        ...
        Private Sub UpdateStockSeries()
            ...
            If Me.radDropDownList1.SelectedItem IsNot Nothing Then
                ...
                If seriesType = "OHLC" Or seriesType = "Candlestick" Then
                    Dim series As OhlcSeries

                    If seriesType = "OHLC" Then
                ...
                Else
                    Dim series As HlcSeries = New HlcSeries()
