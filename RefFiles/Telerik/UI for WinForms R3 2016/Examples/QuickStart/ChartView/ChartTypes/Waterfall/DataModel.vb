...
Namespace Telerik.Examples.WinControls.ChartView.ChartTypes.Waterfall
	Public Class DataModel
		...
		Public Shared Function GetData() As DataTable
			Dim data As DataTable = New DataTable("Europe")
			...
			data.Rows.Add(40000, "Beginning" & Constants.vbLf & "Balance", False, False)
			...
			data.Rows.Add(46000, "Ending" & Constants.vbLf & "Balance", False, True)
