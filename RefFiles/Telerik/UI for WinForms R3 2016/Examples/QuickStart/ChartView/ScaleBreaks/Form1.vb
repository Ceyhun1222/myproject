...
Namespace Telerik.Examples.WinControls.ChartView.ScaleBreaks
	Public Partial Class Form1
		...
		Private Sub radSpinEditorSize_ValueChanged(sender As Object, e As EventArgs)
			Dim axis As CartesianAxis = TryCast(Me.radChartView1.Axes(1), CartesianAxis)
			axis.ScaleBreakSize = CDbl(Me.radSpinEditorSize.Value)
		End Sub

		Private Sub radDropDownListStyle_SelectedIndexChanged(sender As Object, e As Telerik.WinControls.UI.Data.PositionChangedEventArgs)
			Dim axis As CartesianAxis = TryCast(Me.radChartView1.Axes(1), CartesianAxis)
			axis.ScaleBreakStyle = DirectCast(Me.radDropDownListStyle.SelectedItem.Value, ScaleBreakStyle)
		End Sub

		Private Sub radButtonScaleBreaks_Click(sender As Object, e As EventArgs)
			Dim axis As CartesianAxis = TryCast(Me.radChartView1.Axes(1), CartesianAxis)
