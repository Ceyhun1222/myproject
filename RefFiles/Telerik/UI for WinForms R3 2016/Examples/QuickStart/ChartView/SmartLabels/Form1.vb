...
Namespace Telerik.Examples.WinControls.ChartView.SmartLabels
	Partial Public Class Form1
        ...
        Private data_Renamed As New DataModel()
		Private smartLabelsController As SmartLabelsController

		Public Sub New()
			InitializeComponent()

			Me.customTableLayoutPanel1.BackColor = Color.White
		...
		Private Sub InitializeLine()
			...
			For Each dataItem As KeyValuePair(Of Double, Object) In Me.data_Renamed.GetLineOneData()
			...
			For Each dataItem As KeyValuePair(Of Double, Object) In Me.data_Renamed.GetLineTwoData()
				Dim point As New CategoricalDataPoint(dataItem.Key, dataItem.Value)
				point.Label = point.Value
		...
		Private Sub InitializePie()
			...
			For Each dataItem As KeyValuePair(Of Double, Object) In Me.data_Renamed.GetPieData()
		...
		Private Sub InitializeScatter()
			...
			Dim points As List(Of KeyValuePair(Of Double,Double)) = Me.data_Renamed.GetScatterData()
		...
		Private Sub InitializeBar()
			...
			For Each dataItem As KeyValuePair(Of Double, Object) In Me.data_Renamed.GetBarData()
