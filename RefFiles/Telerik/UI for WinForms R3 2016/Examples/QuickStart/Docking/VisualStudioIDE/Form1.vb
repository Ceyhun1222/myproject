...
Namespace Telerik.Examples.WinControls.Docking.VisualStudioIDE
    Partial Public Class Form1
        ...
        Const ErrorGridRow As Integer = 1
        Const ErrorGridLine As Integer = 20
        Const ErrorGridColumn As Integer = 33
        Const ErrorGridFile As String = "Program.cs"
        Const ErrorGridProject As String = "ProjectTracker"
        Const ErrorGridDescription As String = "The type or namespace name 'Form12' could not be found (are you missing a using directive or an assembly reference?)" & vbTab & "C:\ProjectTracker\Program.cs"

        Const TaskGridDescription As String = "TO DO: Refactor the whole data access layer to use Open Access"
        Const TaskGridFile As String = "DBPool.cs"
        Const TaskGridLine As Integer = 501


        Public Sub New()
            InitializeComponent()
            Dim theme As New VisualStudio2012LightTheme()
        ...
        Private Function OpenFile(fileName As String, displayName As String) As DocumentWindow
        ...
        Private Sub SetupAllGrids()
            ...
            Me.radGridViewErrors.Rows.Add(image, ErrorGridRow, ErrorGridDescription, ErrorGridFile, ErrorGridLine, ErrorGridColumn, _
                ErrorGridProject)
        ...
        Private Sub radTreeView1_SelectedNodeChanged(sender As Object, e As RadTreeViewEventArgs) Handles radTreeView1.SelectedNodeChanged
            ...
            If node IsNot Nothing AndAlso node.Tag IsNot Nothing Then
                ...
                For Each dw As DocumentWindow In Me.radDock1.GetWindows(Of DocumentWindow)()
                    ...
                    If tabStrip.PreviewItem IsNot Nothing Then
                        Me.radDock1.CloseWindow(DirectCast(DirectCast(tabStrip.PreviewItem, TabStripItem).TabPanel, DockWindow))
        ...
        Private Sub radTreeView1_NodeMouseDoubleClick(sender As Object, e As RadTreeViewEventArgs) Handles radTreeView1.NodeMouseDoubleClick
        ...
        Private Sub radTreeView1_NodeExpandedChanged(sender As Object, e As RadTreeViewEventArgs) Handles radTreeView1.NodeExpandedChanged
