...
Namespace Telerik.Examples.WinControls.DocumentsProcessing.SpreadsheetStreamingExport
    Partial Public Class Form1
        Inherits ExternalExampleHostForm
        Private ReadOnly ExternalExampleName As String = "SpreadsheetStreamingExport"
