Namespace Telerik.Examples.WinControls.GridView.Filtering.CustomFiltering
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.radGridView.Size = New Size(1310, 700)
			...
			' commandPanel
			' 
			Me.commandPanel.Anchor = (CType(((AnchorStyles.Top Or AnchorStyles.Left) Or AnchorStyles.Right), AnchorStyles))
			Me.commandPanel.BackColor = Color.FromArgb((CInt(Fix((CByte(248))))), (CInt(Fix((CByte(248))))), (CInt(Fix((CByte(248))))))
			Me.commandPanel.Controls.Add(Me.filterTextBox)
			Me.commandPanel.Controls.Add(Me.radLabel1)
			Me.commandPanel.ForeColor = Color.Black
			Me.commandPanel.Location = New Point(12, 6)
			Me.commandPanel.Name = "commandPanel"
			' 
			' 
			' 
			Me.commandPanel.RootElement.ForeColor = Color.Black
			Me.commandPanel.Size = New Size(1310, 37)
			Me.commandPanel.TabIndex = 18
			' 
			' filterTextBox
			' 
			Me.filterTextBox.Anchor = (CType(((AnchorStyles.Top Or AnchorStyles.Left) Or AnchorStyles.Right), AnchorStyles))
			Me.filterTextBox.Location = New Point(63, 9)
			Me.filterTextBox.Name = "filterTextBox"
			Me.filterTextBox.Size = New Size(1235, 21)
