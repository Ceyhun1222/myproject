		...
		Private Sub radGridView1_CellFormatting(ByVal sender As Object, ByVal e As CellFormattingEventArgs)
			...
			If cell IsNot Nothing Then
				If cell.ContainsErrors Then
					...
					cell.BorderRightShadowColor = cell.BorderLeftShadowColor
					cell.BorderTopColor = cell.BorderRightShadowColor
					cell.BorderBottomColor = cell.BorderTopColor
					cell.BorderLeftColor = Color.Red
					cell.BorderRightColor = cell.BorderLeftColor
					cell.BorderTopShadowColor = cell.BorderRightColor
					cell.BorderBottomShadowColor = cell.BorderTopShadowColor
					cell.BorderLeftWidth = 1
					cell.BorderRightWidth = cell.BorderLeftWidth
					cell.BorderTopWidth = cell.BorderRightWidth
					cell.BorderBottomWidth = cell.BorderTopWidth
