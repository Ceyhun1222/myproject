...
Namespace Telerik.Examples.WinControls.GridView.Printing
	Partial Public Class Form1
		...
		Private Sub InitializeGrid()
			...
			tableViewInfo.Columns = New List(Of String) (New String() {"FirstName", "LastName", "Title", "Country", "HomePhone", "Address", "Check", "Combo"})
			...
			columnGroupViewInfo.Columns = New List(Of String) (New String() {"Photo", "FirstName", "LastName", "Title", "Address", "City", "Country", "HomePhone", "Notes"})
			...
			htmlViewInfo.Columns = New List(Of String) (New String() {"Photo", "Title", "FirstName", "LastName", "City", "Country", "Address", "Phone", "BirthDate", "HireDate", "HomePhone"})
