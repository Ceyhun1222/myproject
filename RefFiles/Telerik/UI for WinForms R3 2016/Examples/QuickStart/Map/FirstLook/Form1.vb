    ...
    Partial Public Class Form1
        ...
        Private Sub SetupData()
            ...
            For i As Integer = 0 To data.Count - 1
                ...
                label.Image = DirectCast(myManager.GetObject(If(data(i).IsFlight, "plane_16", "bus_16")), Image)
        ...
        Private Function CreateTripSegment(start As PointG, [end] As PointG, isFlight As Boolean) As MapVisualElement
            If isFlight Then
        ...
        Private Sub MapElement_ViewportChanged(sender As Object, e As ViewportChangedEventArgs)
        ...
        Private Sub RadMap1_Click(sender As Object, e As EventArgs)
            ...
            If pin IsNot Nothing Then
                ...
                Dim myManager As New ResourceManager(GetType(Form1))
                callout.Image = DirectCast(myManager.GetObject(If(tripCity.IsFlight, "plane_16", "bus_16")), Image)
