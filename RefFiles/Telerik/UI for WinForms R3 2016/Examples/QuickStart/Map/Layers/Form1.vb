...
Namespace Telerik.Examples.WinControls.Map.Layers
    Partial Public Class Form1
        ...
        Sub method(sender As Object, e As EventArgs)
            Me.radMap1.BringIntoView(New PointG(40.0, -99.0), 4)
        End Sub
        ...
        Private Sub SetupLegend()
            ...
            For Each teamData As KeyValuePair(Of String, Color) In Me.colors
                ...
                legendItem.ColorElement.Image = DirectCast(My.Resources.ResourceManager.GetObject(teamData.Key), Bitmap)
        ...
        Private Sub radMap1_Click(sender As Object, e As EventArgs) Handles radMap1.Click
            ...
            If pin IsNot Nothing Then
                ...
                callout.Image = DirectCast(My.Resources.ResourceManager.GetObject(pin.Layer.Name + teamInfo.Name.Replace(" ", "")), Bitmap)
            ...
            If item IsNot Nothing Then
                Me.radMap1.Layers(item.TextElement.Text).IsVisible = Not Me.radMap1.Layers(item.TextElement.Text).IsVisible
