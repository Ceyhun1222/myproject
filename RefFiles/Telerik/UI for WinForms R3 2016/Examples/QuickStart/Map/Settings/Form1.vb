...
Namespace Telerik.Examples.WinControls.Map.Settings
    Partial Public Class Form1
        ...
        Private Sub SetupProviders()
            ...
            AddHandler bingProvider.InitializationComplete, AddressOf method

            Me.radMap1.MapElement.Providers.Add(bingProvider)
        End Sub
        Sub method(sender As Object, e As EventArgs)
            Me.radMap1.BringIntoView(New PointG(49.0, 10.0), 5)
        End Sub
        ...
        Private Sub radCheckBoxShowSearchBar_ToggleStateChanged(sender As Object, args As StateChangedEventArgs) Handles radCheckBoxShowSearchBar.ToggleStateChanged
            Me.radMap1.ShowSearchBar = args.ToggleState = ToggleState.[On]
        End Sub

        Private Sub radCheckBoxShowLegend_ToggleStateChanged(sender As Object, args As StateChangedEventArgs) Handles radCheckBoxShowLegend.ToggleStateChanged
            Me.radMap1.ShowLegend = args.ToggleState = ToggleState.[On]

            Me.radGroupBoxLegendSettings.Enabled = Me.radMap1.ShowLegend
        End Sub

        Private Sub radCheckBoxShowNavigationBar_ToggleStateChanged(sender As Object, args As StateChangedEventArgs) Handles radCheckBoxShowNavigationBar.ToggleStateChanged
        ...
        Private Sub radCheckBoxShowScaleIndicator_ToggleStateChanged(sender As Object, args As StateChangedEventArgs) Handles radCheckBoxShowScaleIndicator.ToggleStateChanged
            Me.radMap1.ShowScaleIndicator = args.ToggleState = ToggleState.[On]
        End Sub

        Private Sub radCheckBoxShowMiniMap_ToggleStateChanged(sender As Object, args As StateChangedEventArgs) Handles radCheckBoxShowMiniMap.ToggleStateChanged
            Me.radMap1.ShowMiniMap = args.ToggleState = ToggleState.[On]

            Me.radGroupBoxMinimapSettings.Enabled = Me.radMap1.ShowMiniMap
        End Sub

        Private Sub radRadioButtonVertical_ToggleStateChanged(sender As Object, args As StateChangedEventArgs) Handles radRadioButtonVertical.ToggleStateChanged
        ...
        Private Sub radDropDownListNavBarLocation_SelectedIndexChanged(sender As Object, e As Telerik.WinControls.UI.Data.PositionChangedEventArgs) Handles radDropDownListNavBarLocation.SelectedIndexChanged
            Me.radMap1.MapElement.NavigationBarLocation = DirectCast(Me.radDropDownListNavBarLocation.SelectedItem.Value, MapNavigationBarLocation)
        End Sub

        Private Sub radDropDownListMinimapMode_SelectedIndexChanged(sender As Object, e As Telerik.WinControls.UI.Data.PositionChangedEventArgs) Handles radDropDownListMinimapMode.SelectedIndexChanged
            Me.radMap1.MapElement.MiniMapElement.MiniMapMode = DirectCast(Me.radDropDownListMinimapMode.SelectedItem.Value, MiniMapMode)
            Me.radSpinEditorZoomOffset.Enabled = Me.radMap1.MapElement.MiniMapElement.MiniMapMode = MiniMapMode.OffsetZoom
        End Sub

        Private Sub radSpinEditorZoomOffset_ValueChanged(sender As Object, e As EventArgs) Handles radSpinEditorZoomOffset.ValueChanged
            Me.radMap1.MapElement.MiniMapElement.ZoomOffset = CInt(Me.radSpinEditorZoomOffset.Value)
        End Sub
