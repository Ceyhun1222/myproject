...
Namespace Telerik.Examples.WinControls.Map.Shapefile
    Partial Public Class Form1
        ...
        Private Sub SetupColorizerAndLegend()
            ...
            colorizer.Colors = New List(Of Color)() From { _
                Color.FromArgb(96, 57, 19), _
                Color.FromArgb(204, 0, 0), _
                Color.FromArgb(255, 255, 255), _
                Color.FromArgb(204, 204, 204) _
            }
            ...
            DirectCast(Me.radMap1.MapElement.LegendElement.ItemStackElement.Children(2), MapLegendItemElement).ColorElement.BorderWidth = 3
        End Sub
        ...
        Private Sub radMap1_Click(sender As Object, e As EventArgs)
        ...
        Private Sub radButtonBuyNow_Click(sender As Object, e As EventArgs) Handles radButtonBuyNow.Click
            Me.ShowBookingForm(False)
        End Sub

        Private Sub radButtonReserve_Click(sender As Object, e As EventArgs) Handles radButtonReserve.Click
            Me.ShowBookingForm(True)
        End Sub

        Private Sub ShowBookingForm(isReservation As Boolean)
