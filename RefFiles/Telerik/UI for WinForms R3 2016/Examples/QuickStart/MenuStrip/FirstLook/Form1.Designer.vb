Namespace Telerik.Examples.WinControls.MenuStrip.FirstLook
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			CType(Me.radPanelDemo.GetChildAt(0).GetChildAt(0), Telerik.WinControls.Primitives.FillPrimitive).BackColor2 = Color.White
			CType(Me.radPanelDemo.GetChildAt(0).GetChildAt(0), Telerik.WinControls.Primitives.FillPrimitive).BackColor3 = Color.FromArgb((CInt(Fix((CByte(214))))), (CInt(Fix((CByte(229))))), (CInt(Fix((CByte(237))))))
			CType(Me.radPanelDemo.GetChildAt(0).GetChildAt(0), Telerik.WinControls.Primitives.FillPrimitive).BackColor4 = Color.FromArgb((CInt(Fix((CByte(152))))), (CInt(Fix((CByte(207))))), (CInt(Fix((CByte(221))))))
			...
			CType(Me.radPanelDemo.GetChildAt(0).GetChildAt(0), Telerik.WinControls.Primitives.FillPrimitive).BackColor = Color.White
			...
			CType(Me.radPanelDemo.GetChildAt(0).GetChildAt(1), Telerik.WinControls.Primitives.BorderPrimitive).ForeColor = Color.FromArgb((CInt(Fix((CByte(117))))), (CInt(Fix((CByte(164))))), (CInt(Fix((CByte(188))))))
			' 
			' radPanel1
			' 
