Namespace Telerik.Examples.WinControls.PageView.StripView.FirstLook
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			' radPageViewPage1
			' 
			Me.radPageViewPage1.BackColor = Color.FromArgb((CInt(Fix((CByte(212))))), (CInt(Fix((CByte(208))))), (CInt(Fix((CByte(200))))))
			...
			' radPageViewPage2
			' 
			Me.radPageViewPage2.BackColor = Color.FromArgb((CInt(Fix((CByte(212))))), (CInt(Fix((CByte(208))))), (CInt(Fix((CByte(200))))))
			...
			' radPageViewPage3
			' 
			Me.radPageViewPage3.BackColor = Color.FromArgb((CInt(Fix((CByte(212))))), (CInt(Fix((CByte(208))))), (CInt(Fix((CByte(200))))))
			...
			' radPageViewPage4
			' 
			Me.radPageViewPage4.BackColor = Color.FromArgb((CInt(Fix((CByte(212))))), (CInt(Fix((CByte(208))))), (CInt(Fix((CByte(200))))))
			...
			' radPageViewPage5
			' 
			Me.radPageViewPage5.BackColor = Color.FromArgb((CInt(Fix((CByte(212))))), (CInt(Fix((CByte(208))))), (CInt(Fix((CByte(200))))))
			...
			' radPageViewPage8
			' 
			Me.radPageViewPage8.BackColor = Color.FromArgb((CInt(Fix((CByte(212))))), (CInt(Fix((CByte(208))))), (CInt(Fix((CByte(200))))))
			...
			' radPageViewPage6
			' 
			Me.radPageViewPage6.BackColor = Color.FromArgb((CInt(Fix((CByte(212))))), (CInt(Fix((CByte(208))))), (CInt(Fix((CByte(200))))))
			...
			' radPageViewPage7
			' 
			Me.radPageViewPage7.BackColor = Color.FromArgb((CInt(Fix((CByte(212))))), (CInt(Fix((CByte(208))))), (CInt(Fix((CByte(200))))))
