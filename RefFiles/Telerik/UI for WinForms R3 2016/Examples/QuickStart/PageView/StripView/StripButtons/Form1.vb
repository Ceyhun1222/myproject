...
Namespace Telerik.Examples.WinControls.PageView.StripView.StripButtons
	...
	Partial Public Class Form1
        ...
        Private Sub PopulatePages()
            ...
            For Each seriesType As ChartSeriesType In [Enum].GetValues(GetType(ChartSeriesType))
                ...
                chart.Skin = ChartSkins(System.Math.Max(System.Threading.Interlocked.Increment(skinIndex), skinIndex - 1))
