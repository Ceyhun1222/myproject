...
Namespace Telerik.Examples.WinControls.RibbonBar.MDILayout
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			' radButtonElement5
			' 
			Me.radButtonElement5.AccessibleDescription = "New Form"
			Me.radButtonElement5.AccessibleName = "New Form"
			...
			' radButtonElement29
			' 
			Me.radButtonElement29.AccessibleDescription = "Close Form"
			Me.radButtonElement29.AccessibleName = "Close Form"
			...
			' radButtonElement1
			' 
			Me.radButtonElement1.AccessibleDescription = "Office 2007 Blue"
			Me.radButtonElement1.AccessibleName = "Office 2007 Blue"
			...
			' radButtonElement2
			' 
			Me.radButtonElement2.AccessibleDescription = "Office 2010 Black"
			Me.radButtonElement2.AccessibleName = "Office 2010 Black"
			...
			' radButtonElement3
			' 
			Me.radButtonElement3.AccessibleDescription = "Office 2010 Silver"
			Me.radButtonElement3.AccessibleName = "Office 2010 Silver"
			...
			' 
			Me.radGalleryGroupFilter3.AccessibleDescription = "All Tables"
			Me.radGalleryGroupFilter3.AccessibleName = "All Tables"
			...
			Me.radGalleryGroupFilter3.Visibility = Telerik.WinControls.ElementVisibility.Visible
			' 
			' radGalleryGroupItem1
			' 
			Me.radGalleryGroupItem1.AccessibleDescription = "Plain Tables"
			Me.radGalleryGroupItem1.AccessibleName = "Plain Tables"
			Me.radGalleryGroupItem1.Name = "radGalleryGroupItem1"
			Me.radGalleryGroupItem1.Text = "Plain Tables"
			Me.radGalleryGroupItem1.Visibility = Telerik.WinControls.ElementVisibility.Visible
			' 
			' radGalleryGroupItem2
			' 
			Me.radGalleryGroupItem2.AccessibleDescription = "Built-In"
			Me.radGalleryGroupItem2.AccessibleName = "Built-In"
			Me.radGalleryGroupItem2.Name = "radGalleryGroupItem2"
			Me.radGalleryGroupItem2.Text = "Built-In"
			Me.radGalleryGroupItem2.Visibility = Telerik.WinControls.ElementVisibility.Visible
			' 
			' radGalleryGroupFilter1
			' 
			Me.radGalleryGroupFilter1.AccessibleDescription = "Plain Tables"
			Me.radGalleryGroupFilter1.AccessibleName = "Plain Tables"
			...
			Me.radGalleryGroupFilter1.Visibility = Telerik.WinControls.ElementVisibility.Visible
			' 
			' radGalleryGroupFilter2
			' 
			Me.radGalleryGroupFilter2.AccessibleDescription = "Built-In"
			Me.radGalleryGroupFilter2.AccessibleName = "Built-In"
			...
			Me.radGalleryGroupFilter2.Visibility = Telerik.WinControls.ElementVisibility.Visible
			' 
			' radMenuItem12
			' 
			Me.radMenuItem12.AccessibleDescription = "&Modify Table Style..."
			Me.radMenuItem12.AccessibleName = "&Modify Table Style..."
			...
			' radMenuItem13
			' 
			Me.radMenuItem13.AccessibleDescription = "&Clear"
			Me.radMenuItem13.AccessibleName = "&Clear"
			...
			' radMenuItem14
			' 
			Me.radMenuItem14.AccessibleDescription = "&New Table Style..."
			Me.radMenuItem14.AccessibleName = "&New Table Style..."
			...
			Me.radRibbonBar1.Size = New Size(942, 153)
			...
			Me.radButtonElement41.Visibility = Telerik.WinControls.ElementVisibility.Collapsed
			...
			Me.radButtonElement42.Visibility = Telerik.WinControls.ElementVisibility.Collapsed
			...
			' radMenuItem7
			' 
			Me.radMenuItem7.AccessibleDescription = "Document1"
			Me.radMenuItem7.AccessibleName = "Document1"
			...
			' radMenuItem8
			' 
			Me.radMenuItem8.AccessibleDescription = "Document2"
			Me.radMenuItem8.AccessibleName = "Document2"
			...
			Me.BackColor = Color.FromArgb((CInt(Fix((CByte(217))))), (CInt(Fix((CByte(224))))), (CInt(Fix((CByte(237))))))
