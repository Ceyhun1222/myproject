Namespace Telerik.Examples.WinControls.Scheduler.TimeZones
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			' radScheduler1
			' 
			dateTimeInterval2.End = New Date((CLng(Fix(0))))
			...
			' 
			' 
			Me.radScheduler1.Size = New Size(1157, 578)
			...
			Me.radSchedulerNavigator1.Size = New Size(1157, 77)
			...
			Me.radLabel2.Size = New Size(100, 16)
