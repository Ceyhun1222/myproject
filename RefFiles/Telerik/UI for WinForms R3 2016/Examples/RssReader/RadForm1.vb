...
#Region "Methods"
        ...
        Private Sub AddFeed(ByVal feedUrl As String)
            ...
            Dim splitContainer As RadSplitContainer = GetSplitContainer(TryCast(radDock1.ActiveWindow, DocumentWindow))
...
#Region "Events"
        ...
        Private Sub RadForm1_FormClosing(ByVal sender As Object, ByVal e As FormClosingEventArgs)
            Try
                ...
                Dim textWriter As New XmlTextWriter("saveFeeds.xml", Encoding.UTF8)
        ...
        Private Sub RadForm1_Shown(ByVal sender As Object, ByVal e As EventArgs)
            If File.Exists("dockLayout.xml") AndAlso File.Exists("saveFeeds.xml") Then
                WaitingForm.ShowForm(Nothing)
                radDock1.LoadFromXml("dockLayout.xml")

                Dim serializer As New XmlSerializer(GetType(SaveLoadClass))
                Dim textReader As New XmlTextReader("saveFeeds.xml")
                ...
                For Each window As DockWindow In radDock1.DockWindows
                    For Each savedWindow As DocWindow In savedData.DocWindows
                        If TypeOf window Is DocumentWindow AndAlso window.Text = savedWindow.Text Then
                            ...
                            AddCommandBar(TryCast(window, DocumentWindow))
